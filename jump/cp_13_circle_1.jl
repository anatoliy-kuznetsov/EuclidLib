# NLP written by GAMS Convert at 05/15/24 11:31:23
#
# Equation counts
#     Total        E        G        L        N        X        C        B
...
@constraint(m, e80, x28 - 2 * x40 == 0)
@constraint(m, e81, x29 - 3.0000000000000004 * x40 == 0)
@constraint(m, e82, x30 - 4 * x40 == 0)
@constraint(m, e83, x31 - 4.999999999999999 * x40 == 0)
@constraint(m, e84, x32 - 6 * x40 == 0)
@constraint(m, e85, x33 - 6.999999999999999 * x40 == 0)
@constraint(m, e86, x34 - 7.999999999999998 * x40 == 0)
@constraint(m, e87, x35 - 9.000000000000002 * x40 == 0)
@constraint(m, e88, x36 - 10.000000000000002 * x40 == 0)
@constraint(m, e89, x37 - 11.000000000000002 * x40 == 0)
@constraint(m, e90, x38 - 12 * x40 == 0)
@constraint(m, e91, x39 - 13 * x40 == 0)
