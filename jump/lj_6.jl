# NLP written by GAMS Convert at 05/15/24 11:31:43
#
# Equation counts
#     Total        E        G        L        N        X        C        B
#        15        0       15        0        0        0        0        0
...
@NLobjective(m, Min, ((x1 - x2)^2 + (x7 - x8)^2 + (x13 - x14)^2)^(-3) * (((x1
    - x2)^2 + (x7 - x8)^2 + (x13 - x14)^2)^(-3) - 2) + ((x1 - x3)^2 + (x7 - x9)
    ^2 + (x13 - x15)^2)^(-3) * (((x1 - x3)^2 + (x7 - x9)^2 + (x13 - x15)^2)^(-3)
    - 2) + ((x1 - x4)^2 + (x7 - x10)^2 + (x13 - x16)^2)^(-3) * (((x1 - x4)^2
    + (x7 - x10)^2 + (x13 - x16)^2)^(-3) - 2) + ((x1 - x5)^2 + (x7 - x11)^2 +
    (x13 - x17)^2)^(-3) * (((x1 - x5)^2 + (x7 - x11)^2 + (x13 - x17)^2)^(-3) -
    2) + ((x1 - x6)^2 + (x7 - x12)^2 + (x13 - x18)^2)^(-3) * (((x1 - x6)^2 + (
    x7 - x12)^2 + (x13 - x18)^2)^(-3) - 2) + ((x2 - x3)^2 + (x8 - x9)^2 + (x14
    - x15)^2)^(-3) * (((x2 - x3)^2 + (x8 - x9)^2 + (x14 - x15)^2)^(-3) - 2) +
    ((x2 - x4)^2 + (x8 - x10)^2 + (x14 - x16)^2)^(-3) * (((x2 - x4)^2 + (x8 -
    x10)^2 + (x14 - x16)^2)^(-3) - 2) + ((x2 - x5)^2 + (x8 - x11)^2 + (x14 -
    x17)^2)^(-3) * (((x2 - x5)^2 + (x8 - x11)^2 + (x14 - x17)^2)^(-3) - 2) + ((
    x2 - x6)^2 + (x8 - x12)^2 + (x14 - x18)^2)^(-3) * (((x2 - x6)^2 + (x8 - x12)
    ^2 + (x14 - x18)^2)^(-3) - 2) + ((x3 - x4)^2 + (x9 - x10)^2 + (x15 - x16)^2)
    ^(-3) * (((x3 - x4)^2 + (x9 - x10)^2 + (x15 - x16)^2)^(-3) - 2) + ((x3 - x5)
    ^2 + (x9 - x11)^2 + (x15 - x17)^2)^(-3) * (((x3 - x5)^2 + (x9 - x11)^2 + (
    x15 - x17)^2)^(-3) - 2) + ((x3 - x6)^2 + (x9 - x12)^2 + (x15 - x18)^2)^(-3)
    * (((x3 - x6)^2 + (x9 - x12)^2 + (x15 - x18)^2)^(-3) - 2) + ((x4 - x5)^2
    + (x10 - x11)^2 + (x16 - x17)^2)^(-3) * (((x4 - x5)^2 + (x10 - x11)^2 + (
    x16 - x17)^2)^(-3) - 2) + ((x4 - x6)^2 + (x10 - x12)^2 + (x16 - x18)^2)^(-3)
    * (((x4 - x6)^2 + (x10 - x12)^2 + (x16 - x18)^2)^(-3) - 2) + ((x5 - x6)^2
    + (x11 - x12)^2 + (x17 - x18)^2)^(-3) * (((x5 - x6)^2 + (x11 - x12)^2 + (
    x17 - x18)^2)^(-3) - 2))
