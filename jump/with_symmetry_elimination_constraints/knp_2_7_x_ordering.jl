...
@constraint(m, e22, x1 - x3 <= 0)
@constraint(m, e23, x3 - x5 <= 0)
@constraint(m, e24, x5 - x7 <= 0)
@constraint(m, e25, x7 - x9 <= 0)
@constraint(m, e26, x9 - x11 <= 0)
@constraint(m, e27, x11 - x13 <= 0)
@NLconstraint(m, e28, x1^2 + x2^2 == 4)
@NLconstraint(m, e29, x3^2 + x4^2 == 4)
@NLconstraint(m, e30, x5^2 + x6^2 == 4)
@NLconstraint(m, e31, x7^2 + x8^2 == 4)
@NLconstraint(m, e32, x9^2 + x10^2 == 4)
@NLconstraint(m, e33, x11^2 + x12^2 == 4)
@NLconstraint(m, e34, x13^2 + x14^2 == 4)
