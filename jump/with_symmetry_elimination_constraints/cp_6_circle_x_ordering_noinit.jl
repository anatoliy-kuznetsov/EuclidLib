...
@NLconstraint(m, e21, x1^2 + x7^2 - (1 - x13)^2 <= 0)
@NLconstraint(m, e22, x2^2 + x8^2 - (1 - x13)^2 <= 0)
@NLconstraint(m, e23, x3^2 + x9^2 - (1 - x13)^2 <= 0)
@NLconstraint(m, e24, x4^2 + x10^2 - (1 - x13)^2 <= 0)
@NLconstraint(m, e25, x5^2 + x11^2 - (1 - x13)^2 <= 0)
@NLconstraint(m, e26, x6^2 + x12^2 - (1 - x13)^2 <= 0)
