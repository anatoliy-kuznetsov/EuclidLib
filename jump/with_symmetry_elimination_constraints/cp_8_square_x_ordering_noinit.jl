...
@constraint(m, e36, x1 + x17 <= 0.5)
@constraint(m, e37, x2 + x17 <= 0.5)
@constraint(m, e38, x3 + x17 <= 0.5)
@constraint(m, e39, x4 + x17 <= 0.5)
@constraint(m, e40, x5 + x17 <= 0.5)
@constraint(m, e41, x6 + x17 <= 0.5)
@constraint(m, e42, x7 + x17 <= 0.5)
@constraint(m, e43, x8 + x17 <= 0.5)
@constraint(m, e44, x1 - x17 >= -0.5)
@constraint(m, e45, x2 - x17 >= -0.5)
@constraint(m, e46, x3 - x17 >= -0.5)
@constraint(m, e47, x4 - x17 >= -0.5)
@constraint(m, e48, x5 - x17 >= -0.5)
@constraint(m, e49, x6 - x17 >= -0.5)
@constraint(m, e50, x7 - x17 >= -0.5)
@constraint(m, e51, x8 - x17 >= -0.5)
@constraint(m, e52, x9 + x17 <= 0.5)
@constraint(m, e53, x10 + x17 <= 0.5)
@constraint(m, e54, x11 + x17 <= 0.5)
@constraint(m, e55, x12 + x17 <= 0.5)
@constraint(m, e56, x13 + x17 <= 0.5)
@constraint(m, e57, x14 + x17 <= 0.5)
@constraint(m, e58, x15 + x17 <= 0.5)
@constraint(m, e59, x16 + x17 <= 0.5)
@constraint(m, e60, x9 - x17 >= -0.5)
@constraint(m, e61, x10 - x17 >= -0.5)
@constraint(m, e62, x11 - x17 >= -0.5)
@constraint(m, e63, x12 - x17 >= -0.5)
@constraint(m, e64, x13 - x17 >= -0.5)
@constraint(m, e65, x14 - x17 >= -0.5)
@constraint(m, e66, x15 - x17 >= -0.5)
@constraint(m, e67, x16 - x17 >= -0.5)
