...
@NLconstraint(m, e28, x1^2 + x8^2 - (1 - x15)^2 <= 0)
@NLconstraint(m, e29, x2^2 + x9^2 - (1 - x15)^2 <= 0)
@NLconstraint(m, e30, x3^2 + x10^2 - (1 - x15)^2 <= 0)
@NLconstraint(m, e31, x4^2 + x11^2 - (1 - x15)^2 <= 0)
@NLconstraint(m, e32, x5^2 + x12^2 - (1 - x15)^2 <= 0)
@NLconstraint(m, e33, x6^2 + x13^2 - (1 - x15)^2 <= 0)
@NLconstraint(m, e34, x7^2 + x14^2 - (1 - x15)^2 <= 0)
