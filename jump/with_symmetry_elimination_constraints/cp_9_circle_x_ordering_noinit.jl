...
@NLconstraint(m, e45, x1^2 + x10^2 - (1 - x19)^2 <= 0)
@NLconstraint(m, e46, x2^2 + x11^2 - (1 - x19)^2 <= 0)
@NLconstraint(m, e47, x3^2 + x12^2 - (1 - x19)^2 <= 0)
@NLconstraint(m, e48, x4^2 + x13^2 - (1 - x19)^2 <= 0)
@NLconstraint(m, e49, x5^2 + x14^2 - (1 - x19)^2 <= 0)
@NLconstraint(m, e50, x6^2 + x15^2 - (1 - x19)^2 <= 0)
@NLconstraint(m, e51, x7^2 + x16^2 - (1 - x19)^2 <= 0)
@NLconstraint(m, e52, x8^2 + x17^2 - (1 - x19)^2 <= 0)
@NLconstraint(m, e53, x9^2 + x18^2 - (1 - x19)^2 <= 0)
