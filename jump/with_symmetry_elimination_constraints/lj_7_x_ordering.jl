...
@NLobjective(m, Min, ((x1 - x2)^2 + (x8 - x9)^2 + (x15 - x16)^2)^(-3) * (((x1
    - x2)^2 + (x8 - x9)^2 + (x15 - x16)^2)^(-3) - 2) + ((x1 - x3)^2 + (x8 -
    x10)^2 + (x15 - x17)^2)^(-3) * (((x1 - x3)^2 + (x8 - x10)^2 + (x15 - x17)^2)
    ^(-3) - 2) + ((x1 - x4)^2 + (x8 - x11)^2 + (x15 - x18)^2)^(-3) * (((x1 - x4)
    ^2 + (x8 - x11)^2 + (x15 - x18)^2)^(-3) - 2) + ((x1 - x5)^2 + (x8 - x12)^2
    + (x15 - x19)^2)^(-3) * (((x1 - x5)^2 + (x8 - x12)^2 + (x15 - x19)^2)^(-3)
    - 2) + ((x1 - x6)^2 + (x8 - x13)^2 + (x15 - x20)^2)^(-3) * (((x1 - x6)^2
    + (x8 - x13)^2 + (x15 - x20)^2)^(-3) - 2) + ((x1 - x7)^2 + (x8 - x14)^2 +
    (x15 - x21)^2)^(-3) * (((x1 - x7)^2 + (x8 - x14)^2 + (x15 - x21)^2)^(-3) -
    2) + ((x2 - x3)^2 + (x9 - x10)^2 + (x16 - x17)^2)^(-3) * (((x2 - x3)^2 + (
    x9 - x10)^2 + (x16 - x17)^2)^(-3) - 2) + ((x2 - x4)^2 + (x9 - x11)^2 + (x16
    - x18)^2)^(-3) * (((x2 - x4)^2 + (x9 - x11)^2 + (x16 - x18)^2)^(-3) - 2)
    + ((x2 - x5)^2 + (x9 - x12)^2 + (x16 - x19)^2)^(-3) * (((x2 - x5)^2 + (x9
    - x12)^2 + (x16 - x19)^2)^(-3) - 2) + ((x2 - x6)^2 + (x9 - x13)^2 + (x16
    - x20)^2)^(-3) * (((x2 - x6)^2 + (x9 - x13)^2 + (x16 - x20)^2)^(-3) - 2)
    + ((x2 - x7)^2 + (x9 - x14)^2 + (x16 - x21)^2)^(-3) * (((x2 - x7)^2 + (x9
    - x14)^2 + (x16 - x21)^2)^(-3) - 2) + ((x3 - x4)^2 + (x10 - x11)^2 + (x17
    - x18)^2)^(-3) * (((x3 - x4)^2 + (x10 - x11)^2 + (x17 - x18)^2)^(-3) - 2)
    + ((x3 - x5)^2 + (x10 - x12)^2 + (x17 - x19)^2)^(-3) * (((x3 - x5)^2 + (
    x10 - x12)^2 + (x17 - x19)^2)^(-3) - 2) + ((x3 - x6)^2 + (x10 - x13)^2 + (
    x17 - x20)^2)^(-3) * (((x3 - x6)^2 + (x10 - x13)^2 + (x17 - x20)^2)^(-3) -
    2) + ((x3 - x7)^2 + (x10 - x14)^2 + (x17 - x21)^2)^(-3) * (((x3 - x7)^2 + (
    x10 - x14)^2 + (x17 - x21)^2)^(-3) - 2) + ((x4 - x5)^2 + (x11 - x12)^2 + (
    x18 - x19)^2)^(-3) * (((x4 - x5)^2 + (x11 - x12)^2 + (x18 - x19)^2)^(-3) -
    2) + ((x4 - x6)^2 + (x11 - x13)^2 + (x18 - x20)^2)^(-3) * (((x4 - x6)^2 + (
    x11 - x13)^2 + (x18 - x20)^2)^(-3) - 2) + ((x4 - x7)^2 + (x11 - x14)^2 + (
    x18 - x21)^2)^(-3) * (((x4 - x7)^2 + (x11 - x14)^2 + (x18 - x21)^2)^(-3) -
    2) + ((x5 - x6)^2 + (x12 - x13)^2 + (x19 - x20)^2)^(-3) * (((x5 - x6)^2 + (
    x12 - x13)^2 + (x19 - x20)^2)^(-3) - 2) + ((x5 - x7)^2 + (x12 - x14)^2 + (
    x19 - x21)^2)^(-3) * (((x5 - x7)^2 + (x12 - x14)^2 + (x19 - x21)^2)^(-3) -
    2) + ((x6 - x7)^2 + (x13 - x14)^2 + (x20 - x21)^2)^(-3) * (((x6 - x7)^2 + (
    x13 - x14)^2 + (x20 - x21)^2)^(-3) - 2))
