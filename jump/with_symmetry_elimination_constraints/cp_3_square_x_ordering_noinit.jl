...
@constraint(m, e6, x1 + x7 <= 0.5)
@constraint(m, e7, x2 + x7 <= 0.5)
@constraint(m, e8, x3 + x7 <= 0.5)
@constraint(m, e9, x1 - x7 >= -0.5)
@constraint(m, e10, x2 - x7 >= -0.5)
@constraint(m, e11, x3 - x7 >= -0.5)
@constraint(m, e12, x4 + x7 <= 0.5)
@constraint(m, e13, x5 + x7 <= 0.5)
@constraint(m, e14, x6 + x7 <= 0.5)
@constraint(m, e15, x4 - x7 >= -0.5)
@constraint(m, e16, x5 - x7 >= -0.5)
@constraint(m, e17, x6 - x7 >= -0.5)
