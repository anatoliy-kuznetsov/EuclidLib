...
@NLobjective(m, Min, exp(-6 * sqrt((x1 - x2)^2 + (x11 - x12)^2 + (x21 - x22)^2)
    ...
    2) + exp(-6 * sqrt((x1 - x3)^2 + (x11 - x13)^2 + (x21 - x23)^2) + 6) * (
    exp(-6 * sqrt((x1 - x3)^2 + (x11 - x13)^2 + (x21 - x23)^2) + 6) - 2) + exp(
    -6 * sqrt((x1 - x4)^2 + (x11 - x14)^2 + (x21 - x24)^2) + 6) * (exp(-6 *
    sqrt((x1 - x4)^2 + (x11 - x14)^2 + (x21 - x24)^2) + 6) - 2) + exp(-6 *
    sqrt((x1 - x5)^2 + (x11 - x15)^2 + (x21 - x25)^2) + 6) * (exp(-6 * sqrt((x1
    - x5)^2 + (x11 - x15)^2 + (x21 - x25)^2) + 6) - 2) + exp(-6 * sqrt((x1 -
    x6)^2 + (x11 - x16)^2 + (x21 - x26)^2) + 6) * (exp(-6 * sqrt((x1 - x6)^2 +
    (x11 - x16)^2 + (x21 - x26)^2) + 6) - 2) + exp(-6 * sqrt((x1 - x7)^2 + (x11
    - x17)^2 + (x21 - x27)^2) + 6) * (exp(-6 * sqrt((x1 - x7)^2 + (x11 - x17)^
    2 + (x21 - x27)^2) + 6) - 2) + exp(-6 * sqrt((x1 - x8)^2 + (x11 - x18)^2 +
    (x21 - x28)^2) + 6) * (exp(-6 * sqrt((x1 - x8)^2 + (x11 - x18)^2 + (x21 -
    x28)^2) + 6) - 2) + exp(-6 * sqrt((x1 - x9)^2 + (x11 - x19)^2 + (x21 - x29)
    ^2) + 6) * (exp(-6 * sqrt((x1 - x9)^2 + (x11 - x19)^2 + (x21 - x29)^2) + 6)
    - 2) + exp(-6 * sqrt((x1 - x10)^2 + (x11 - x20)^2 + (x21 - x30)^2) + 6) *
    (exp(-6 * sqrt((x1 - x10)^2 + (x11 - x20)^2 + (x21 - x30)^2) + 6) - 2) +
    exp(-6 * sqrt((x2 - x3)^2 + (x12 - x13)^2 + (x22 - x23)^2) + 6) * (exp(-6
    * sqrt((x2 - x3)^2 + (x12 - x13)^2 + (x22 - x23)^2) + 6) - 2) + exp(-6 *
    sqrt((x2 - x4)^2 + (x12 - x14)^2 + (x22 - x24)^2) + 6) * (exp(-6 * sqrt((x2
    - x4)^2 + (x12 - x14)^2 + (x22 - x24)^2) + 6) - 2) + exp(-6 * sqrt((x2 -
    x5)^2 + (x12 - x15)^2 + (x22 - x25)^2) + 6) * (exp(-6 * sqrt((x2 - x5)^2 +
    (x12 - x15)^2 + (x22 - x25)^2) + 6) - 2) + exp(-6 * sqrt((x2 - x6)^2 + (x12
    - x16)^2 + (x22 - x26)^2) + 6) * (exp(-6 * sqrt((x2 - x6)^2 + (x12 - x16)^
    2 + (x22 - x26)^2) + 6) - 2) + exp(-6 * sqrt((x2 - x7)^2 + (x12 - x17)^2 +
