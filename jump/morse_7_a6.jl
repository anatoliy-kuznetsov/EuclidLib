# NLP written by GAMS Convert at 05/15/24 11:36:57
#
# Equation counts
#     Total        E        G        L        N        X        C        B
#        21        0       21        0        0        0        0        0
...
@NLobjective(m, Min, exp(-6 * sqrt((x1 - x2)^2 + (x8 - x9)^2 + (x15 - x16)^2)
    ...
    * (exp(-6 * sqrt((x2 - x3)^2 + (x9 - x10)^2 + (x16 - x17)^2) + 6) - 2) +
    ...
    sqrt((x3 - x6)^2 + (x10 - x13)^2 + (x17 - x20)^2) + 6) - 2) + exp(-6 *
    sqrt((x3 - x7)^2 + (x10 - x14)^2 + (x17 - x21)^2) + 6) * (exp(-6 * sqrt((x3
    - x7)^2 + (x10 - x14)^2 + (x17 - x21)^2) + 6) - 2) + exp(-6 * sqrt((x4 -
    x5)^2 + (x11 - x12)^2 + (x18 - x19)^2) + 6) * (exp(-6 * sqrt((x4 - x5)^2 +
    (x11 - x12)^2 + (x18 - x19)^2) + 6) - 2) + exp(-6 * sqrt((x4 - x6)^2 + (x11
    - x13)^2 + (x18 - x20)^2) + 6) * (exp(-6 * sqrt((x4 - x6)^2 + (x11 - x13)^
    2 + (x18 - x20)^2) + 6) - 2) + exp(-6 * sqrt((x4 - x7)^2 + (x11 - x14)^2 +
