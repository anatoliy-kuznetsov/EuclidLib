...
@constraint(m, e57, x24 - 0.7071067811865476 * x34 == 0)
@constraint(m, e58, x25 - 0.5773502691896257 * x34 == 0)
@constraint(m, e59, x26 - 0.5 * x34 == 0)
@constraint(m, e60, x27 - 0.447213595499958 * x34 == 0)
@constraint(m, e61, x28 - 0.408248290463863 * x34 == 0)
@constraint(m, e62, x29 - 0.37796447300922725 * x34 == 0)
@constraint(m, e63, x30 - 0.3535533905932738 * x34 == 0)
@constraint(m, e64, x31 - 0.3333333333333333 * x34 == 0)
@constraint(m, e65, x32 - 0.3162277660168379 * x34 == 0)
@constraint(m, e66, x33 - 0.30151134457776363 * x34 == 0)
