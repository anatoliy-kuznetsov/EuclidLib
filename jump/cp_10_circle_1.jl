# NLP written by GAMS Convert at 05/15/24 11:33:34
#
# Equation counts
#     Total        E        G        L        N        X        C        B
#        65       10       45       10        0        0        0        0
...
@constraint(m, e47, x22 - 2 * x31 == 0)
@constraint(m, e48, x23 - 3.0000000000000004 * x31 == 0)
@constraint(m, e49, x24 - 4 * x31 == 0)
@constraint(m, e50, x25 - 4.999999999999999 * x31 == 0)
@constraint(m, e51, x26 - 6 * x31 == 0)
@constraint(m, e52, x27 - 6.999999999999999 * x31 == 0)
@constraint(m, e53, x28 - 7.999999999999998 * x31 == 0)
@constraint(m, e54, x29 - 9.000000000000002 * x31 == 0)
@constraint(m, e55, x30 - 10.000000000000002 * x31 == 0)
