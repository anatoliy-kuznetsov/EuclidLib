...
@constraint(m, e30, x18 - 2 * x25 == 0)
@constraint(m, e31, x19 - 3.0000000000000004 * x25 == 0)
@constraint(m, e32, x20 - 4 * x25 == 0)
@constraint(m, e33, x21 - 4.999999999999999 * x25 == 0)
@constraint(m, e34, x22 - 6 * x25 == 0)
@constraint(m, e35, x23 - 6.999999999999999 * x25 == 0)
@constraint(m, e36, x24 - 7.999999999999998 * x25 == 0)
