...
@constraint(m, e38, x20 - 2 * x28 == 0)
@constraint(m, e39, x21 - 3.0000000000000004 * x28 == 0)
@constraint(m, e40, x22 - 4 * x28 == 0)
@constraint(m, e41, x23 - 4.999999999999999 * x28 == 0)
@constraint(m, e42, x24 - 6 * x28 == 0)
@constraint(m, e43, x25 - 6.999999999999999 * x28 == 0)
@constraint(m, e44, x26 - 7.999999999999998 * x28 == 0)
@constraint(m, e45, x27 - 9.000000000000002 * x28 == 0)
