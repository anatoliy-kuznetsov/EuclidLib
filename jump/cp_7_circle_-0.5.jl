...
@constraint(m, e23, x16 - 0.7071067811865476 * x22 == 0)
@constraint(m, e24, x17 - 0.5773502691896257 * x22 == 0)
@constraint(m, e25, x18 - 0.5 * x22 == 0)
@constraint(m, e26, x19 - 0.447213595499958 * x22 == 0)
@constraint(m, e27, x20 - 0.408248290463863 * x22 == 0)
@constraint(m, e28, x21 - 0.37796447300922725 * x22 == 0)
