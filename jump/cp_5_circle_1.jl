# NLP written by GAMS Convert at 05/15/24 11:30:06
#
# Equation counts
#     Total        E        G        L        N        X        C        B
#        20        5       10        5        0        0        0        0
...
@constraint(m, e12, x12 - 2 * x16 == 0)
@constraint(m, e13, x13 - 3.0000000000000004 * x16 == 0)
@constraint(m, e14, x14 - 4 * x16 == 0)
@constraint(m, e15, x15 - 4.999999999999999 * x16 == 0)
