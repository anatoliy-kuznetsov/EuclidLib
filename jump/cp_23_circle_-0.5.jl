# NLP written by GAMS Convert at 05/15/24 11:30:28
#
# Equation counts
#     Total        E        G        L        N        X        C        B
...
@constraint(m, e255, x48 - 0.7071067811865476 * x70 == 0)
@constraint(m, e256, x49 - 0.5773502691896257 * x70 == 0)
@constraint(m, e257, x50 - 0.5 * x70 == 0)
@constraint(m, e258, x51 - 0.447213595499958 * x70 == 0)
@constraint(m, e259, x52 - 0.408248290463863 * x70 == 0)
@constraint(m, e260, x53 - 0.37796447300922725 * x70 == 0)
@constraint(m, e261, x54 - 0.3535533905932738 * x70 == 0)
@constraint(m, e262, x55 - 0.3333333333333333 * x70 == 0)
@constraint(m, e263, x56 - 0.3162277660168379 * x70 == 0)
@constraint(m, e264, x57 - 0.30151134457776363 * x70 == 0)
@constraint(m, e265, x58 - 0.28867513459481287 * x70 == 0)
@constraint(m, e266, x59 - 0.2773500981126146 * x70 == 0)
@constraint(m, e267, x60 - 0.2672612419124244 * x70 == 0)
@constraint(m, e268, x61 - 0.25819888974716115 * x70 == 0)
@constraint(m, e269, x62 - 0.25 * x70 == 0)
@constraint(m, e270, x63 - 0.24253562503633297 * x70 == 0)
@constraint(m, e271, x64 - 0.23570226039551587 * x70 == 0)
@constraint(m, e272, x65 - 0.2294157338705618 * x70 == 0)
@constraint(m, e273, x66 - 0.223606797749979 * x70 == 0)
@constraint(m, e274, x67 - 0.2182178902359924 * x70 == 0)
@constraint(m, e275, x68 - 0.21320071635561041 * x70 == 0)
@constraint(m, e276, x69 - 0.20851441405707477 * x70 == 0)
