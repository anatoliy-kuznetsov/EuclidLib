# NLP written by GAMS Convert at 05/15/24 11:29:05
#
# Equation counts
#     Total        E        G        L        N        X        C        B
#        28        0       28        0        0        0        0        0
...
@NLobjective(m, Min, ((x1 - x2)^2 + (x9 - x10)^2 + (x17 - x18)^2)^(-3) * (((x1
    - x2)^2 + (x9 - x10)^2 + (x17 - x18)^2)^(-3) - 2) + ((x1 - x3)^2 + (x9 -
    x11)^2 + (x17 - x19)^2)^(-3) * (((x1 - x3)^2 + (x9 - x11)^2 + (x17 - x19)^2)
    ^(-3) - 2) + ((x1 - x4)^2 + (x9 - x12)^2 + (x17 - x20)^2)^(-3) * (((x1 - x4)
    ^2 + (x9 - x12)^2 + (x17 - x20)^2)^(-3) - 2) + ((x1 - x5)^2 + (x9 - x13)^2
    + (x17 - x21)^2)^(-3) * (((x1 - x5)^2 + (x9 - x13)^2 + (x17 - x21)^2)^(-3)
    - 2) + ((x1 - x6)^2 + (x9 - x14)^2 + (x17 - x22)^2)^(-3) * (((x1 - x6)^2
    + (x9 - x14)^2 + (x17 - x22)^2)^(-3) - 2) + ((x1 - x7)^2 + (x9 - x15)^2 +
    (x17 - x23)^2)^(-3) * (((x1 - x7)^2 + (x9 - x15)^2 + (x17 - x23)^2)^(-3) -
    2) + ((x1 - x8)^2 + (x9 - x16)^2 + (x17 - x24)^2)^(-3) * (((x1 - x8)^2 + (
    x9 - x16)^2 + (x17 - x24)^2)^(-3) - 2) + ((x2 - x3)^2 + (x10 - x11)^2 + (
    x18 - x19)^2)^(-3) * (((x2 - x3)^2 + (x10 - x11)^2 + (x18 - x19)^2)^(-3) -
    2) + ((x2 - x4)^2 + (x10 - x12)^2 + (x18 - x20)^2)^(-3) * (((x2 - x4)^2 + (
    x10 - x12)^2 + (x18 - x20)^2)^(-3) - 2) + ((x2 - x5)^2 + (x10 - x13)^2 + (
    x18 - x21)^2)^(-3) * (((x2 - x5)^2 + (x10 - x13)^2 + (x18 - x21)^2)^(-3) -
    2) + ((x2 - x6)^2 + (x10 - x14)^2 + (x18 - x22)^2)^(-3) * (((x2 - x6)^2 + (
    x10 - x14)^2 + (x18 - x22)^2)^(-3) - 2) + ((x2 - x7)^2 + (x10 - x15)^2 + (
    x18 - x23)^2)^(-3) * (((x2 - x7)^2 + (x10 - x15)^2 + (x18 - x23)^2)^(-3) -
    2) + ((x2 - x8)^2 + (x10 - x16)^2 + (x18 - x24)^2)^(-3) * (((x2 - x8)^2 + (
    x10 - x16)^2 + (x18 - x24)^2)^(-3) - 2) + ((x3 - x4)^2 + (x11 - x12)^2 + (
    x19 - x20)^2)^(-3) * (((x3 - x4)^2 + (x11 - x12)^2 + (x19 - x20)^2)^(-3) -
    2) + ((x3 - x5)^2 + (x11 - x13)^2 + (x19 - x21)^2)^(-3) * (((x3 - x5)^2 + (
    x11 - x13)^2 + (x19 - x21)^2)^(-3) - 2) + ((x3 - x6)^2 + (x11 - x14)^2 + (
    x19 - x22)^2)^(-3) * (((x3 - x6)^2 + (x11 - x14)^2 + (x19 - x22)^2)^(-3) -
    2) + ((x3 - x7)^2 + (x11 - x15)^2 + (x19 - x23)^2)^(-3) * (((x3 - x7)^2 + (
    x11 - x15)^2 + (x19 - x23)^2)^(-3) - 2) + ((x3 - x8)^2 + (x11 - x16)^2 + (
    x19 - x24)^2)^(-3) * (((x3 - x8)^2 + (x11 - x16)^2 + (x19 - x24)^2)^(-3) -
    2) + ((x4 - x5)^2 + (x12 - x13)^2 + (x20 - x21)^2)^(-3) * (((x4 - x5)^2 + (
    x12 - x13)^2 + (x20 - x21)^2)^(-3) - 2) + ((x4 - x6)^2 + (x12 - x14)^2 + (
    x20 - x22)^2)^(-3) * (((x4 - x6)^2 + (x12 - x14)^2 + (x20 - x22)^2)^(-3) -
    2) + ((x4 - x7)^2 + (x12 - x15)^2 + (x20 - x23)^2)^(-3) * (((x4 - x7)^2 + (
    x12 - x15)^2 + (x20 - x23)^2)^(-3) - 2) + ((x4 - x8)^2 + (x12 - x16)^2 + (
    x20 - x24)^2)^(-3) * (((x4 - x8)^2 + (x12 - x16)^2 + (x20 - x24)^2)^(-3) -
    2) + ((x5 - x6)^2 + (x13 - x14)^2 + (x21 - x22)^2)^(-3) * (((x5 - x6)^2 + (
    x13 - x14)^2 + (x21 - x22)^2)^(-3) - 2) + ((x5 - x7)^2 + (x13 - x15)^2 + (
    x21 - x23)^2)^(-3) * (((x5 - x7)^2 + (x13 - x15)^2 + (x21 - x23)^2)^(-3) -
    2) + ((x5 - x8)^2 + (x13 - x16)^2 + (x21 - x24)^2)^(-3) * (((x5 - x8)^2 + (
    x13 - x16)^2 + (x21 - x24)^2)^(-3) - 2) + ((x6 - x7)^2 + (x14 - x15)^2 + (
    x22 - x23)^2)^(-3) * (((x6 - x7)^2 + (x14 - x15)^2 + (x22 - x23)^2)^(-3) -
    2) + ((x6 - x8)^2 + (x14 - x16)^2 + (x22 - x24)^2)^(-3) * (((x6 - x8)^2 + (
    x14 - x16)^2 + (x22 - x24)^2)^(-3) - 2) + ((x7 - x8)^2 + (x15 - x16)^2 + (
    x23 - x24)^2)^(-3) * (((x7 - x8)^2 + (x15 - x16)^2 + (x23 - x24)^2)^(-3) -
    2))
