# NLP written by GAMS Convert at 05/15/24 11:33:51
#
# Equation counts
#     Total        E        G        L        N        X        C        B
#        56        7       35       14        0        0        0        0
...
@constraint(m, e29, x1 + x15 <= 0.5)
@constraint(m, e30, x2 + x16 <= 0.5)
@constraint(m, e31, x3 + x17 <= 0.5)
@constraint(m, e32, x4 + x18 <= 0.5)
@constraint(m, e33, x5 + x19 <= 0.5)
@constraint(m, e34, x6 + x20 <= 0.5)
@constraint(m, e35, x7 + x21 <= 0.5)
@constraint(m, e36, x1 - x15 >= -0.5)
@constraint(m, e37, x2 - x16 >= -0.5)
@constraint(m, e38, x3 - x17 >= -0.5)
@constraint(m, e39, x4 - x18 >= -0.5)
@constraint(m, e40, x5 - x19 >= -0.5)
@constraint(m, e41, x6 - x20 >= -0.5)
@constraint(m, e42, x7 - x21 >= -0.5)
@constraint(m, e43, x8 + x15 <= 0.5)
@constraint(m, e44, x9 + x16 <= 0.5)
@constraint(m, e45, x10 + x17 <= 0.5)
@constraint(m, e46, x11 + x18 <= 0.5)
@constraint(m, e47, x12 + x19 <= 0.5)
@constraint(m, e48, x13 + x20 <= 0.5)
@constraint(m, e49, x14 + x21 <= 0.5)
@constraint(m, e50, x8 - x15 >= -0.5)
@constraint(m, e51, x9 - x16 >= -0.5)
@constraint(m, e52, x10 - x17 >= -0.5)
@constraint(m, e53, x11 - x18 >= -0.5)
@constraint(m, e54, x12 - x19 >= -0.5)
@constraint(m, e55, x13 - x20 >= -0.5)
@constraint(m, e56, x14 - x21 >= -0.5)
