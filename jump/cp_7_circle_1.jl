...
@constraint(m, e23, x16 - 2 * x22 == 0)
@constraint(m, e24, x17 - 3.0000000000000004 * x22 == 0)
@constraint(m, e25, x18 - 4 * x22 == 0)
@constraint(m, e26, x19 - 4.999999999999999 * x22 == 0)
@constraint(m, e27, x20 - 6 * x22 == 0)
@constraint(m, e28, x21 - 6.999999999999999 * x22 == 0)
