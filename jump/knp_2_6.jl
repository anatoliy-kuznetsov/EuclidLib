...
@NLconstraint(m, e16, x1^2 + x2^2 == 4)
@NLconstraint(m, e17, x3^2 + x4^2 == 4)
@NLconstraint(m, e18, x5^2 + x6^2 == 4)
@NLconstraint(m, e19, x7^2 + x8^2 == 4)
@NLconstraint(m, e20, x9^2 + x10^2 == 4)
@NLconstraint(m, e21, x11^2 + x12^2 == 4)
