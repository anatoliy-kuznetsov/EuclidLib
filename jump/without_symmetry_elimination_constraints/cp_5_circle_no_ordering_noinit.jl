...
@NLconstraint(m, e11, x1^2 + x6^2 - (1 - x11)^2 <= 0)
@NLconstraint(m, e12, x2^2 + x7^2 - (1 - x11)^2 <= 0)
@NLconstraint(m, e13, x3^2 + x8^2 - (1 - x11)^2 <= 0)
@NLconstraint(m, e14, x4^2 + x9^2 - (1 - x11)^2 <= 0)
@NLconstraint(m, e15, x5^2 + x10^2 - (1 - x11)^2 <= 0)
