...
@constraint(m, e22, x1 + x15 <= 0.5)
@constraint(m, e23, x2 + x15 <= 0.5)
@constraint(m, e24, x3 + x15 <= 0.5)
@constraint(m, e25, x4 + x15 <= 0.5)
@constraint(m, e26, x5 + x15 <= 0.5)
@constraint(m, e27, x6 + x15 <= 0.5)
@constraint(m, e28, x7 + x15 <= 0.5)
@constraint(m, e29, x1 - x15 >= -0.5)
@constraint(m, e30, x2 - x15 >= -0.5)
@constraint(m, e31, x3 - x15 >= -0.5)
@constraint(m, e32, x4 - x15 >= -0.5)
@constraint(m, e33, x5 - x15 >= -0.5)
@constraint(m, e34, x6 - x15 >= -0.5)
@constraint(m, e35, x7 - x15 >= -0.5)
@constraint(m, e36, x8 + x15 <= 0.5)
@constraint(m, e37, x9 + x15 <= 0.5)
@constraint(m, e38, x10 + x15 <= 0.5)
@constraint(m, e39, x11 + x15 <= 0.5)
@constraint(m, e40, x12 + x15 <= 0.5)
@constraint(m, e41, x13 + x15 <= 0.5)
@constraint(m, e42, x14 + x15 <= 0.5)
@constraint(m, e43, x8 - x15 >= -0.5)
@constraint(m, e44, x9 - x15 >= -0.5)
@constraint(m, e45, x10 - x15 >= -0.5)
@constraint(m, e46, x11 - x15 >= -0.5)
@constraint(m, e47, x12 - x15 >= -0.5)
@constraint(m, e48, x13 - x15 >= -0.5)
@constraint(m, e49, x14 - x15 >= -0.5)
