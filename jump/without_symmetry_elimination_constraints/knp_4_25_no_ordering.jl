...
@NLconstraint(m, e300, (x93 - x97)^2 + (x94 - x98)^2 + (x95 - x99)^2 + (x96 -
    x100)^2 - x101 >= 0)
@NLconstraint(m, e301, x1^2 + x2^2 + x3^2 + x4^2 == 4)
@NLconstraint(m, e302, x5^2 + x6^2 + x7^2 + x8^2 == 4)
@NLconstraint(m, e303, x9^2 + x10^2 + x11^2 + x12^2 == 4)
@NLconstraint(m, e304, x13^2 + x14^2 + x15^2 + x16^2 == 4)
@NLconstraint(m, e305, x17^2 + x18^2 + x19^2 + x20^2 == 4)
@NLconstraint(m, e306, x21^2 + x22^2 + x23^2 + x24^2 == 4)
@NLconstraint(m, e307, x25^2 + x26^2 + x27^2 + x28^2 == 4)
@NLconstraint(m, e308, x29^2 + x30^2 + x31^2 + x32^2 == 4)
@NLconstraint(m, e309, x33^2 + x34^2 + x35^2 + x36^2 == 4)
@NLconstraint(m, e310, x37^2 + x38^2 + x39^2 + x40^2 == 4)
@NLconstraint(m, e311, x41^2 + x42^2 + x43^2 + x44^2 == 4)
@NLconstraint(m, e312, x45^2 + x46^2 + x47^2 + x48^2 == 4)
@NLconstraint(m, e313, x49^2 + x50^2 + x51^2 + x52^2 == 4)
@NLconstraint(m, e314, x53^2 + x54^2 + x55^2 + x56^2 == 4)
@NLconstraint(m, e315, x57^2 + x58^2 + x59^2 + x60^2 == 4)
@NLconstraint(m, e316, x61^2 + x62^2 + x63^2 + x64^2 == 4)
@NLconstraint(m, e317, x65^2 + x66^2 + x67^2 + x68^2 == 4)
@NLconstraint(m, e318, x69^2 + x70^2 + x71^2 + x72^2 == 4)
@NLconstraint(m, e319, x73^2 + x74^2 + x75^2 + x76^2 == 4)
@NLconstraint(m, e320, x77^2 + x78^2 + x79^2 + x80^2 == 4)
@NLconstraint(m, e321, x81^2 + x82^2 + x83^2 + x84^2 == 4)
@NLconstraint(m, e322, x85^2 + x86^2 + x87^2 + x88^2 == 4)
@NLconstraint(m, e323, x89^2 + x90^2 + x91^2 + x92^2 == 4)
@NLconstraint(m, e324, x93^2 + x94^2 + x95^2 + x96^2 == 4)
@NLconstraint(m, e325, x97^2 + x98^2 + x99^2 + x100^2 == 4)
