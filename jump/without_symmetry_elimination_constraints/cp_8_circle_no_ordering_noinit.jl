...
@NLconstraint(m, e29, x1^2 + x9^2 - (1 - x17)^2 <= 0)
@NLconstraint(m, e30, x2^2 + x10^2 - (1 - x17)^2 <= 0)
@NLconstraint(m, e31, x3^2 + x11^2 - (1 - x17)^2 <= 0)
@NLconstraint(m, e32, x4^2 + x12^2 - (1 - x17)^2 <= 0)
@NLconstraint(m, e33, x5^2 + x13^2 - (1 - x17)^2 <= 0)
@NLconstraint(m, e34, x6^2 + x14^2 - (1 - x17)^2 <= 0)
@NLconstraint(m, e35, x7^2 + x15^2 - (1 - x17)^2 <= 0)
@NLconstraint(m, e36, x8^2 + x16^2 - (1 - x17)^2 <= 0)
