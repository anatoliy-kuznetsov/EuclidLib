...
@constraint(m, e7, x1 + x9 <= 0.5)
@constraint(m, e8, x2 + x9 <= 0.5)
@constraint(m, e9, x3 + x9 <= 0.5)
@constraint(m, e10, x4 + x9 <= 0.5)
@constraint(m, e11, x1 - x9 >= -0.5)
@constraint(m, e12, x2 - x9 >= -0.5)
@constraint(m, e13, x3 - x9 >= -0.5)
@constraint(m, e14, x4 - x9 >= -0.5)
@constraint(m, e15, x5 + x9 <= 0.5)
@constraint(m, e16, x6 + x9 <= 0.5)
@constraint(m, e17, x7 + x9 <= 0.5)
@constraint(m, e18, x8 + x9 <= 0.5)
@constraint(m, e19, x5 - x9 >= -0.5)
@constraint(m, e20, x6 - x9 >= -0.5)
@constraint(m, e21, x7 - x9 >= -0.5)
@constraint(m, e22, x8 - x9 >= -0.5)
