...
@constraint(m, e29, x1 + x17 <= 0.5)
@constraint(m, e30, x2 + x17 <= 0.5)
@constraint(m, e31, x3 + x17 <= 0.5)
@constraint(m, e32, x4 + x17 <= 0.5)
@constraint(m, e33, x5 + x17 <= 0.5)
@constraint(m, e34, x6 + x17 <= 0.5)
@constraint(m, e35, x7 + x17 <= 0.5)
@constraint(m, e36, x8 + x17 <= 0.5)
@constraint(m, e37, x1 - x17 >= -0.5)
@constraint(m, e38, x2 - x17 >= -0.5)
@constraint(m, e39, x3 - x17 >= -0.5)
@constraint(m, e40, x4 - x17 >= -0.5)
@constraint(m, e41, x5 - x17 >= -0.5)
@constraint(m, e42, x6 - x17 >= -0.5)
@constraint(m, e43, x7 - x17 >= -0.5)
@constraint(m, e44, x8 - x17 >= -0.5)
@constraint(m, e45, x9 + x17 <= 0.5)
@constraint(m, e46, x10 + x17 <= 0.5)
@constraint(m, e47, x11 + x17 <= 0.5)
@constraint(m, e48, x12 + x17 <= 0.5)
@constraint(m, e49, x13 + x17 <= 0.5)
@constraint(m, e50, x14 + x17 <= 0.5)
@constraint(m, e51, x15 + x17 <= 0.5)
@constraint(m, e52, x16 + x17 <= 0.5)
@constraint(m, e53, x9 - x17 >= -0.5)
@constraint(m, e54, x10 - x17 >= -0.5)
@constraint(m, e55, x11 - x17 >= -0.5)
@constraint(m, e56, x12 - x17 >= -0.5)
@constraint(m, e57, x13 - x17 >= -0.5)
@constraint(m, e58, x14 - x17 >= -0.5)
@constraint(m, e59, x15 - x17 >= -0.5)
@constraint(m, e60, x16 - x17 >= -0.5)
