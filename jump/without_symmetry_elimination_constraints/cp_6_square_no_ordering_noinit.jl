...
@constraint(m, e16, x1 + x13 <= 0.5)
@constraint(m, e17, x2 + x13 <= 0.5)
@constraint(m, e18, x3 + x13 <= 0.5)
@constraint(m, e19, x4 + x13 <= 0.5)
@constraint(m, e20, x5 + x13 <= 0.5)
@constraint(m, e21, x6 + x13 <= 0.5)
@constraint(m, e22, x1 - x13 >= -0.5)
@constraint(m, e23, x2 - x13 >= -0.5)
@constraint(m, e24, x3 - x13 >= -0.5)
@constraint(m, e25, x4 - x13 >= -0.5)
@constraint(m, e26, x5 - x13 >= -0.5)
@constraint(m, e27, x6 - x13 >= -0.5)
@constraint(m, e28, x7 + x13 <= 0.5)
@constraint(m, e29, x8 + x13 <= 0.5)
@constraint(m, e30, x9 + x13 <= 0.5)
@constraint(m, e31, x10 + x13 <= 0.5)
@constraint(m, e32, x11 + x13 <= 0.5)
@constraint(m, e33, x12 + x13 <= 0.5)
@constraint(m, e34, x7 - x13 >= -0.5)
@constraint(m, e35, x8 - x13 >= -0.5)
@constraint(m, e36, x9 - x13 >= -0.5)
@constraint(m, e37, x10 - x13 >= -0.5)
@constraint(m, e38, x11 - x13 >= -0.5)
@constraint(m, e39, x12 - x13 >= -0.5)
