...
@NLconstraint(m, e46, x1^2 + x11^2 - (1 - x21)^2 <= 0)
@NLconstraint(m, e47, x2^2 + x12^2 - (1 - x21)^2 <= 0)
@NLconstraint(m, e48, x3^2 + x13^2 - (1 - x21)^2 <= 0)
@NLconstraint(m, e49, x4^2 + x14^2 - (1 - x21)^2 <= 0)
@NLconstraint(m, e50, x5^2 + x15^2 - (1 - x21)^2 <= 0)
@NLconstraint(m, e51, x6^2 + x16^2 - (1 - x21)^2 <= 0)
@NLconstraint(m, e52, x7^2 + x17^2 - (1 - x21)^2 <= 0)
@NLconstraint(m, e53, x8^2 + x18^2 - (1 - x21)^2 <= 0)
@NLconstraint(m, e54, x9^2 + x19^2 - (1 - x21)^2 <= 0)
@NLconstraint(m, e55, x10^2 + x20^2 - (1 - x21)^2 <= 0)
