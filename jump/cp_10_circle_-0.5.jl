# NLP written by GAMS Convert at 05/15/24 11:30:25
#
# Equation counts
#     Total        E        G        L        N        X        C        B
#        65       10       45       10        0        0        0        0
...
@constraint(m, e47, x22 - 0.7071067811865476 * x31 == 0)
@constraint(m, e48, x23 - 0.5773502691896257 * x31 == 0)
@constraint(m, e49, x24 - 0.5 * x31 == 0)
@constraint(m, e50, x25 - 0.447213595499958 * x31 == 0)
@constraint(m, e51, x26 - 0.408248290463863 * x31 == 0)
@constraint(m, e52, x27 - 0.37796447300922725 * x31 == 0)
@constraint(m, e53, x28 - 0.3535533905932738 * x31 == 0)
@constraint(m, e54, x29 - 0.3333333333333333 * x31 == 0)
@constraint(m, e55, x30 - 0.3162277660168379 * x31 == 0)
