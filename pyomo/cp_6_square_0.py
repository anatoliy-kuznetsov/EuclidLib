...
m.e15 = Constraint(expr= (m.x5 - m.x6)**2 + (m.x11 - m.x12)**2 - (m.x17 + m.x18)
    **2 >= 0)
m.e16 = Constraint(expr= m.x13 - m.x19 == 0)
m.e17 = Constraint(expr= m.x14 - m.x19 == 0)
m.e18 = Constraint(expr= m.x15 - m.x19 == 0)
m.e19 = Constraint(expr= m.x16 - m.x19 == 0)
m.e20 = Constraint(expr= m.x17 - m.x19 == 0)
m.e21 = Constraint(expr= m.x18 - m.x19 == 0)
m.e22 = Constraint(expr= m.x1 + m.x13 <= 0.5)
m.e23 = Constraint(expr= m.x2 + m.x14 <= 0.5)
m.e24 = Constraint(expr= m.x3 + m.x15 <= 0.5)
m.e25 = Constraint(expr= m.x4 + m.x16 <= 0.5)
m.e26 = Constraint(expr= m.x5 + m.x17 <= 0.5)
m.e27 = Constraint(expr= m.x6 + m.x18 <= 0.5)
m.e28 = Constraint(expr= m.x1 - m.x13 >= -0.5)
m.e29 = Constraint(expr= m.x2 - m.x14 >= -0.5)
m.e30 = Constraint(expr= m.x3 - m.x15 >= -0.5)
m.e31 = Constraint(expr= m.x4 - m.x16 >= -0.5)
m.e32 = Constraint(expr= m.x5 - m.x17 >= -0.5)
m.e33 = Constraint(expr= m.x6 - m.x18 >= -0.5)
m.e34 = Constraint(expr= m.x7 + m.x13 <= 0.5)
m.e35 = Constraint(expr= m.x8 + m.x14 <= 0.5)
m.e36 = Constraint(expr= m.x9 + m.x15 <= 0.5)
m.e37 = Constraint(expr= m.x10 + m.x16 <= 0.5)
m.e38 = Constraint(expr= m.x11 + m.x17 <= 0.5)
m.e39 = Constraint(expr= m.x12 + m.x18 <= 0.5)
m.e40 = Constraint(expr= m.x7 - m.x13 >= -0.5)
m.e41 = Constraint(expr= m.x8 - m.x14 >= -0.5)
m.e42 = Constraint(expr= m.x9 - m.x15 >= -0.5)
m.e43 = Constraint(expr= m.x10 - m.x16 >= -0.5)
m.e44 = Constraint(expr= m.x11 - m.x17 >= -0.5)
m.e45 = Constraint(expr= m.x12 - m.x18 >= -0.5)
