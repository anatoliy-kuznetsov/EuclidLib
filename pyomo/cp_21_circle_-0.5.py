...
m.e212 = Constraint(expr= m.x44 - 0.7071067811865476 * m.x64 == 0)
m.e213 = Constraint(expr= m.x45 - 0.5773502691896257 * m.x64 == 0)
m.e214 = Constraint(expr= m.x46 - 0.5 * m.x64 == 0)
m.e215 = Constraint(expr= m.x47 - 0.447213595499958 * m.x64 == 0)
m.e216 = Constraint(expr= m.x48 - 0.408248290463863 * m.x64 == 0)
m.e217 = Constraint(expr= m.x49 - 0.37796447300922725 * m.x64 == 0)
m.e218 = Constraint(expr= m.x50 - 0.3535533905932738 * m.x64 == 0)
m.e219 = Constraint(expr= m.x51 - 0.3333333333333333 * m.x64 == 0)
m.e220 = Constraint(expr= m.x52 - 0.3162277660168379 * m.x64 == 0)
m.e221 = Constraint(expr= m.x53 - 0.30151134457776363 * m.x64 == 0)
m.e222 = Constraint(expr= m.x54 - 0.28867513459481287 * m.x64 == 0)
m.e223 = Constraint(expr= m.x55 - 0.2773500981126146 * m.x64 == 0)
m.e224 = Constraint(expr= m.x56 - 0.2672612419124244 * m.x64 == 0)
m.e225 = Constraint(expr= m.x57 - 0.25819888974716115 * m.x64 == 0)
m.e226 = Constraint(expr= m.x58 - 0.25 * m.x64 == 0)
m.e227 = Constraint(expr= m.x59 - 0.24253562503633297 * m.x64 == 0)
m.e228 = Constraint(expr= m.x60 - 0.23570226039551587 * m.x64 == 0)
m.e229 = Constraint(expr= m.x61 - 0.2294157338705618 * m.x64 == 0)
m.e230 = Constraint(expr= m.x62 - 0.223606797749979 * m.x64 == 0)
m.e231 = Constraint(expr= m.x63 - 0.2182178902359924 * m.x64 == 0)
