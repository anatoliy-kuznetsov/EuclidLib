...
m.e17 = Constraint(expr= m.x14 - 2 * m.x19 == 0)
m.e18 = Constraint(expr= m.x15 - 3.0000000000000004 * m.x19 == 0)
m.e19 = Constraint(expr= m.x16 - 4 * m.x19 == 0)
m.e20 = Constraint(expr= m.x17 - 4.999999999999999 * m.x19 == 0)
m.e21 = Constraint(expr= m.x18 - 6 * m.x19 == 0)
m.e22 = Constraint(expr= m.x1**2 + m.x7**2 - (1 - m.x13)**2 <= 0)
m.e23 = Constraint(expr= m.x2**2 + m.x8**2 - (1 - m.x14)**2 <= 0)
m.e24 = Constraint(expr= m.x3**2 + m.x9**2 - (1 - m.x15)**2 <= 0)
m.e25 = Constraint(expr= m.x4**2 + m.x10**2 - (1 - m.x16)**2 <= 0)
m.e26 = Constraint(expr= m.x5**2 + m.x11**2 - (1 - m.x17)**2 <= 0)
m.e27 = Constraint(expr= m.x6**2 + m.x12**2 - (1 - m.x18)**2 <= 0)
