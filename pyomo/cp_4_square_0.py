...
m.e8 = Constraint(expr= m.x10 - m.x13 == 0)
m.e9 = Constraint(expr= m.x11 - m.x13 == 0)
m.e10 = Constraint(expr= m.x12 - m.x13 == 0)
m.e11 = Constraint(expr= m.x1 + m.x9 <= 0.5)
m.e12 = Constraint(expr= m.x2 + m.x10 <= 0.5)
m.e13 = Constraint(expr= m.x3 + m.x11 <= 0.5)
m.e14 = Constraint(expr= m.x4 + m.x12 <= 0.5)
m.e15 = Constraint(expr= m.x1 - m.x9 >= -0.5)
m.e16 = Constraint(expr= m.x2 - m.x10 >= -0.5)
m.e17 = Constraint(expr= m.x3 - m.x11 >= -0.5)
m.e18 = Constraint(expr= m.x4 - m.x12 >= -0.5)
m.e19 = Constraint(expr= m.x5 + m.x9 <= 0.5)
m.e20 = Constraint(expr= m.x6 + m.x10 <= 0.5)
m.e21 = Constraint(expr= m.x7 + m.x11 <= 0.5)
m.e22 = Constraint(expr= m.x8 + m.x12 <= 0.5)
m.e23 = Constraint(expr= m.x5 - m.x9 >= -0.5)
m.e24 = Constraint(expr= m.x6 - m.x10 >= -0.5)
m.e25 = Constraint(expr= m.x7 - m.x11 >= -0.5)
m.e26 = Constraint(expr= m.x8 - m.x12 >= -0.5)
