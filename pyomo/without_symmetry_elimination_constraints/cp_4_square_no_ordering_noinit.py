...
m.e6 = Constraint(expr= (m.x3 - m.x4)**2 + (m.x7 - m.x8)**2 - (2 * m.x9)**2
    >= 0)
m.e7 = Constraint(expr= m.x1 + m.x9 <= 0.5)
m.e8 = Constraint(expr= m.x2 + m.x9 <= 0.5)
m.e9 = Constraint(expr= m.x3 + m.x9 <= 0.5)
m.e10 = Constraint(expr= m.x4 + m.x9 <= 0.5)
m.e11 = Constraint(expr= m.x1 - m.x9 >= -0.5)
m.e12 = Constraint(expr= m.x2 - m.x9 >= -0.5)
m.e13 = Constraint(expr= m.x3 - m.x9 >= -0.5)
m.e14 = Constraint(expr= m.x4 - m.x9 >= -0.5)
m.e15 = Constraint(expr= m.x5 + m.x9 <= 0.5)
m.e16 = Constraint(expr= m.x6 + m.x9 <= 0.5)
m.e17 = Constraint(expr= m.x7 + m.x9 <= 0.5)
m.e18 = Constraint(expr= m.x8 + m.x9 <= 0.5)
m.e19 = Constraint(expr= m.x5 - m.x9 >= -0.5)
m.e20 = Constraint(expr= m.x6 - m.x9 >= -0.5)
m.e21 = Constraint(expr= m.x7 - m.x9 >= -0.5)
m.e22 = Constraint(expr= m.x8 - m.x9 >= -0.5)
