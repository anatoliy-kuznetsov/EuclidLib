...
m.e45 = Constraint(expr= (m.x9 - m.x10)**2 + (m.x19 - m.x20)**2 - (2 * m.x21)**
    2 >= 0)
m.e46 = Constraint(expr= m.x1**2 + m.x11**2 - (1 - m.x21)**2 <= 0)
m.e47 = Constraint(expr= m.x2**2 + m.x12**2 - (1 - m.x21)**2 <= 0)
m.e48 = Constraint(expr= m.x3**2 + m.x13**2 - (1 - m.x21)**2 <= 0)
m.e49 = Constraint(expr= m.x4**2 + m.x14**2 - (1 - m.x21)**2 <= 0)
m.e50 = Constraint(expr= m.x5**2 + m.x15**2 - (1 - m.x21)**2 <= 0)
m.e51 = Constraint(expr= m.x6**2 + m.x16**2 - (1 - m.x21)**2 <= 0)
m.e52 = Constraint(expr= m.x7**2 + m.x17**2 - (1 - m.x21)**2 <= 0)
m.e53 = Constraint(expr= m.x8**2 + m.x18**2 - (1 - m.x21)**2 <= 0)
m.e54 = Constraint(expr= m.x9**2 + m.x19**2 - (1 - m.x21)**2 <= 0)
m.e55 = Constraint(expr= m.x10**2 + m.x20**2 - (1 - m.x21)**2 <= 0)
