...
m.e6 = Constraint(expr= (m.x3 - m.x4)**2 + (m.x7 - m.x8)**2 - (2 * m.x9)**2
    >= 0)
m.e7 = Constraint(expr= m.x1**2 + m.x5**2 - (1 - m.x9)**2 <= 0)
m.e8 = Constraint(expr= m.x2**2 + m.x6**2 - (1 - m.x9)**2 <= 0)
m.e9 = Constraint(expr= m.x3**2 + m.x7**2 - (1 - m.x9)**2 <= 0)
m.e10 = Constraint(expr= m.x4**2 + m.x8**2 - (1 - m.x9)**2 <= 0)
