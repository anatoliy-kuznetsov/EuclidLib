...
m.e10 = Constraint(expr= (m.x4 - m.x5)**2 + (m.x9 - m.x10)**2 - (2 * m.x11)**2
    >= 0)
m.e11 = Constraint(expr= m.x1 + m.x11 <= 0.5)
m.e12 = Constraint(expr= m.x2 + m.x11 <= 0.5)
m.e13 = Constraint(expr= m.x3 + m.x11 <= 0.5)
m.e14 = Constraint(expr= m.x4 + m.x11 <= 0.5)
m.e15 = Constraint(expr= m.x5 + m.x11 <= 0.5)
m.e16 = Constraint(expr= m.x1 - m.x11 >= -0.5)
m.e17 = Constraint(expr= m.x2 - m.x11 >= -0.5)
m.e18 = Constraint(expr= m.x3 - m.x11 >= -0.5)
m.e19 = Constraint(expr= m.x4 - m.x11 >= -0.5)
m.e20 = Constraint(expr= m.x5 - m.x11 >= -0.5)
m.e21 = Constraint(expr= m.x6 + m.x11 <= 0.5)
m.e22 = Constraint(expr= m.x7 + m.x11 <= 0.5)
m.e23 = Constraint(expr= m.x8 + m.x11 <= 0.5)
m.e24 = Constraint(expr= m.x9 + m.x11 <= 0.5)
m.e25 = Constraint(expr= m.x10 + m.x11 <= 0.5)
m.e26 = Constraint(expr= m.x6 - m.x11 >= -0.5)
m.e27 = Constraint(expr= m.x7 - m.x11 >= -0.5)
m.e28 = Constraint(expr= m.x8 - m.x11 >= -0.5)
m.e29 = Constraint(expr= m.x9 - m.x11 >= -0.5)
m.e30 = Constraint(expr= m.x10 - m.x11 >= -0.5)
