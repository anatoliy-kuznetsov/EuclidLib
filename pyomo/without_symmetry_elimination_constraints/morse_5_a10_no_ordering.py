...
m.obj = Objective(sense=minimize, expr= exp(-10 * sqrt((m.x1 - m.x2)**2 + (m.x6
    - m.x7)**2 + (m.x11 - m.x12)**2) + 10) * (exp(-10 * sqrt((m.x1 - m.x2)**2
    + (m.x6 - m.x7)**2 + (m.x11 - m.x12)**2) + 10) - 2) + exp(-10 * sqrt((m.x1
    - m.x3)**2 + (m.x6 - m.x8)**2 + (m.x11 - m.x13)**2) + 10) * (exp(-10 *
    sqrt((m.x1 - m.x3)**2 + (m.x6 - m.x8)**2 + (m.x11 - m.x13)**2) + 10) - 2)
    + exp(-10 * sqrt((m.x1 - m.x4)**2 + (m.x6 - m.x9)**2 + (m.x11 - m.x14)**2)
    + 10) * (exp(-10 * sqrt((m.x1 - m.x4)**2 + (m.x6 - m.x9)**2 + (m.x11 -
    m.x14)**2) + 10) - 2) + exp(-10 * sqrt((m.x1 - m.x5)**2 + (m.x6 - m.x10)**2
    + (m.x11 - m.x15)**2) + 10) * (exp(-10 * sqrt((m.x1 - m.x5)**2 + (m.x6 -
    m.x10)**2 + (m.x11 - m.x15)**2) + 10) - 2) + exp(-10 * sqrt((m.x2 - m.x3)**
    2 + (m.x7 - m.x8)**2 + (m.x12 - m.x13)**2) + 10) * (exp(-10 * sqrt((m.x2 -
    m.x3)**2 + (m.x7 - m.x8)**2 + (m.x12 - m.x13)**2) + 10) - 2) + exp(-10 *
    sqrt((m.x2 - m.x4)**2 + (m.x7 - m.x9)**2 + (m.x12 - m.x14)**2) + 10) * (exp
    (-10 * sqrt((m.x2 - m.x4)**2 + (m.x7 - m.x9)**2 + (m.x12 - m.x14)**2) + 10)
    - 2) + exp(-10 * sqrt((m.x2 - m.x5)**2 + (m.x7 - m.x10)**2 + (m.x12 -
    m.x15)**2) + 10) * (exp(-10 * sqrt((m.x2 - m.x5)**2 + (m.x7 - m.x10)**2 + (
    m.x12 - m.x15)**2) + 10) - 2) + exp(-10 * sqrt((m.x3 - m.x4)**2 + (m.x8 -
    m.x9)**2 + (m.x13 - m.x14)**2) + 10) * (exp(-10 * sqrt((m.x3 - m.x4)**2 + (
    m.x8 - m.x9)**2 + (m.x13 - m.x14)**2) + 10) - 2) + exp(-10 * sqrt((m.x3 -
    m.x5)**2 + (m.x8 - m.x10)**2 + (m.x13 - m.x15)**2) + 10) * (exp(-10 * sqrt(
    (m.x3 - m.x5)**2 + (m.x8 - m.x10)**2 + (m.x13 - m.x15)**2) + 10) - 2) + exp
    (-10 * sqrt((m.x4 - m.x5)**2 + (m.x9 - m.x10)**2 + (m.x14 - m.x15)**2) + 10)
    * (exp(-10 * sqrt((m.x4 - m.x5)**2 + (m.x9 - m.x10)**2 + (m.x14 - m.x15)**
    2) + 10) - 2))
