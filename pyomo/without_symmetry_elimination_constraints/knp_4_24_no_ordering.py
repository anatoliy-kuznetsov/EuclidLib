...
m.e277 = Constraint(expr= m.x1**2 + m.x2**2 + m.x3**2 + m.x4**2 == 4)
m.e278 = Constraint(expr= m.x5**2 + m.x6**2 + m.x7**2 + m.x8**2 == 4)
m.e279 = Constraint(expr= m.x9**2 + m.x10**2 + m.x11**2 + m.x12**2 == 4)
m.e280 = Constraint(expr= m.x13**2 + m.x14**2 + m.x15**2 + m.x16**2 == 4)
m.e281 = Constraint(expr= m.x17**2 + m.x18**2 + m.x19**2 + m.x20**2 == 4)
m.e282 = Constraint(expr= m.x21**2 + m.x22**2 + m.x23**2 + m.x24**2 == 4)
m.e283 = Constraint(expr= m.x25**2 + m.x26**2 + m.x27**2 + m.x28**2 == 4)
m.e284 = Constraint(expr= m.x29**2 + m.x30**2 + m.x31**2 + m.x32**2 == 4)
m.e285 = Constraint(expr= m.x33**2 + m.x34**2 + m.x35**2 + m.x36**2 == 4)
m.e286 = Constraint(expr= m.x37**2 + m.x38**2 + m.x39**2 + m.x40**2 == 4)
m.e287 = Constraint(expr= m.x41**2 + m.x42**2 + m.x43**2 + m.x44**2 == 4)
m.e288 = Constraint(expr= m.x45**2 + m.x46**2 + m.x47**2 + m.x48**2 == 4)
m.e289 = Constraint(expr= m.x49**2 + m.x50**2 + m.x51**2 + m.x52**2 == 4)
m.e290 = Constraint(expr= m.x53**2 + m.x54**2 + m.x55**2 + m.x56**2 == 4)
m.e291 = Constraint(expr= m.x57**2 + m.x58**2 + m.x59**2 + m.x60**2 == 4)
m.e292 = Constraint(expr= m.x61**2 + m.x62**2 + m.x63**2 + m.x64**2 == 4)
m.e293 = Constraint(expr= m.x65**2 + m.x66**2 + m.x67**2 + m.x68**2 == 4)
m.e294 = Constraint(expr= m.x69**2 + m.x70**2 + m.x71**2 + m.x72**2 == 4)
m.e295 = Constraint(expr= m.x73**2 + m.x74**2 + m.x75**2 + m.x76**2 == 4)
m.e296 = Constraint(expr= m.x77**2 + m.x78**2 + m.x79**2 + m.x80**2 == 4)
m.e297 = Constraint(expr= m.x81**2 + m.x82**2 + m.x83**2 + m.x84**2 == 4)
m.e298 = Constraint(expr= m.x85**2 + m.x86**2 + m.x87**2 + m.x88**2 == 4)
m.e299 = Constraint(expr= m.x89**2 + m.x90**2 + m.x91**2 + m.x92**2 == 4)
m.e300 = Constraint(expr= m.x93**2 + m.x94**2 + m.x95**2 + m.x96**2 == 4)
