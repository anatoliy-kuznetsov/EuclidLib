...
m.e36 = Constraint(expr= (m.x8 - m.x9)**2 + (m.x17 - m.x18)**2 - (2 * m.x19)**2
    >= 0)
m.e37 = Constraint(expr= m.x1**2 + m.x10**2 - (1 - m.x19)**2 <= 0)
m.e38 = Constraint(expr= m.x2**2 + m.x11**2 - (1 - m.x19)**2 <= 0)
m.e39 = Constraint(expr= m.x3**2 + m.x12**2 - (1 - m.x19)**2 <= 0)
m.e40 = Constraint(expr= m.x4**2 + m.x13**2 - (1 - m.x19)**2 <= 0)
m.e41 = Constraint(expr= m.x5**2 + m.x14**2 - (1 - m.x19)**2 <= 0)
m.e42 = Constraint(expr= m.x6**2 + m.x15**2 - (1 - m.x19)**2 <= 0)
m.e43 = Constraint(expr= m.x7**2 + m.x16**2 - (1 - m.x19)**2 <= 0)
m.e44 = Constraint(expr= m.x8**2 + m.x17**2 - (1 - m.x19)**2 <= 0)
m.e45 = Constraint(expr= m.x9**2 + m.x18**2 - (1 - m.x19)**2 <= 0)
