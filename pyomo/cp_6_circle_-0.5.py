...
m.e17 = Constraint(expr= m.x14 - 0.7071067811865476 * m.x19 == 0)
m.e18 = Constraint(expr= m.x15 - 0.5773502691896257 * m.x19 == 0)
m.e19 = Constraint(expr= m.x16 - 0.5 * m.x19 == 0)
m.e20 = Constraint(expr= m.x17 - 0.447213595499958 * m.x19 == 0)
m.e21 = Constraint(expr= m.x18 - 0.408248290463863 * m.x19 == 0)
