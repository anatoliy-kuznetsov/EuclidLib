...
m.e93 = Constraint(expr= m.x30 - 0.7071067811865476 * m.x43 == 0)
m.e94 = Constraint(expr= m.x31 - 0.5773502691896257 * m.x43 == 0)
m.e95 = Constraint(expr= m.x32 - 0.5 * m.x43 == 0)
m.e96 = Constraint(expr= m.x33 - 0.447213595499958 * m.x43 == 0)
m.e97 = Constraint(expr= m.x34 - 0.408248290463863 * m.x43 == 0)
m.e98 = Constraint(expr= m.x35 - 0.37796447300922725 * m.x43 == 0)
m.e99 = Constraint(expr= m.x36 - 0.3535533905932738 * m.x43 == 0)
m.e100 = Constraint(expr= m.x37 - 0.3333333333333333 * m.x43 == 0)
m.e101 = Constraint(expr= m.x38 - 0.3162277660168379 * m.x43 == 0)
m.e102 = Constraint(expr= m.x39 - 0.30151134457776363 * m.x43 == 0)
m.e103 = Constraint(expr= m.x40 - 0.28867513459481287 * m.x43 == 0)
m.e104 = Constraint(expr= m.x41 - 0.2773500981126146 * m.x43 == 0)
m.e105 = Constraint(expr= m.x42 - 0.2672612419124244 * m.x43 == 0)
