...
m.e120 = Constraint(expr= (m.x15 - m.x16)**2 + (m.x31 - m.x32)**2 - (m.x47 +
    m.x48)**2 >= 0)
m.e121 = Constraint(expr= m.x33 - m.x49 == 0)
m.e122 = Constraint(expr= m.x34 - m.x49 == 0)
m.e123 = Constraint(expr= m.x35 - m.x49 == 0)
m.e124 = Constraint(expr= m.x36 - m.x49 == 0)
m.e125 = Constraint(expr= m.x37 - m.x49 == 0)
m.e126 = Constraint(expr= m.x38 - m.x49 == 0)
m.e127 = Constraint(expr= m.x39 - m.x49 == 0)
m.e128 = Constraint(expr= m.x40 - m.x49 == 0)
m.e129 = Constraint(expr= m.x41 - m.x49 == 0)
m.e130 = Constraint(expr= m.x42 - m.x49 == 0)
m.e131 = Constraint(expr= m.x43 - m.x49 == 0)
m.e132 = Constraint(expr= m.x44 - m.x49 == 0)
m.e133 = Constraint(expr= m.x45 - m.x49 == 0)
m.e134 = Constraint(expr= m.x46 - m.x49 == 0)
m.e135 = Constraint(expr= m.x47 - m.x49 == 0)
m.e136 = Constraint(expr= m.x48 - m.x49 == 0)
m.e137 = Constraint(expr= m.x1 + m.x33 <= 0.5)
m.e138 = Constraint(expr= m.x2 + m.x34 <= 0.5)
m.e139 = Constraint(expr= m.x3 + m.x35 <= 0.5)
m.e140 = Constraint(expr= m.x4 + m.x36 <= 0.5)
m.e141 = Constraint(expr= m.x5 + m.x37 <= 0.5)
m.e142 = Constraint(expr= m.x6 + m.x38 <= 0.5)
m.e143 = Constraint(expr= m.x7 + m.x39 <= 0.5)
m.e144 = Constraint(expr= m.x8 + m.x40 <= 0.5)
m.e145 = Constraint(expr= m.x9 + m.x41 <= 0.5)
m.e146 = Constraint(expr= m.x10 + m.x42 <= 0.5)
m.e147 = Constraint(expr= m.x11 + m.x43 <= 0.5)
m.e148 = Constraint(expr= m.x12 + m.x44 <= 0.5)
m.e149 = Constraint(expr= m.x13 + m.x45 <= 0.5)
m.e150 = Constraint(expr= m.x14 + m.x46 <= 0.5)
m.e151 = Constraint(expr= m.x15 + m.x47 <= 0.5)
m.e152 = Constraint(expr= m.x16 + m.x48 <= 0.5)
m.e153 = Constraint(expr= m.x1 - m.x33 >= -0.5)
m.e154 = Constraint(expr= m.x2 - m.x34 >= -0.5)
m.e155 = Constraint(expr= m.x3 - m.x35 >= -0.5)
m.e156 = Constraint(expr= m.x4 - m.x36 >= -0.5)
m.e157 = Constraint(expr= m.x5 - m.x37 >= -0.5)
m.e158 = Constraint(expr= m.x6 - m.x38 >= -0.5)
m.e159 = Constraint(expr= m.x7 - m.x39 >= -0.5)
m.e160 = Constraint(expr= m.x8 - m.x40 >= -0.5)
m.e161 = Constraint(expr= m.x9 - m.x41 >= -0.5)
m.e162 = Constraint(expr= m.x10 - m.x42 >= -0.5)
m.e163 = Constraint(expr= m.x11 - m.x43 >= -0.5)
m.e164 = Constraint(expr= m.x12 - m.x44 >= -0.5)
m.e165 = Constraint(expr= m.x13 - m.x45 >= -0.5)
m.e166 = Constraint(expr= m.x14 - m.x46 >= -0.5)
m.e167 = Constraint(expr= m.x15 - m.x47 >= -0.5)
m.e168 = Constraint(expr= m.x16 - m.x48 >= -0.5)
m.e169 = Constraint(expr= m.x17 + m.x33 <= 0.5)
m.e170 = Constraint(expr= m.x18 + m.x34 <= 0.5)
m.e171 = Constraint(expr= m.x19 + m.x35 <= 0.5)
m.e172 = Constraint(expr= m.x20 + m.x36 <= 0.5)
m.e173 = Constraint(expr= m.x21 + m.x37 <= 0.5)
m.e174 = Constraint(expr= m.x22 + m.x38 <= 0.5)
m.e175 = Constraint(expr= m.x23 + m.x39 <= 0.5)
m.e176 = Constraint(expr= m.x24 + m.x40 <= 0.5)
m.e177 = Constraint(expr= m.x25 + m.x41 <= 0.5)
m.e178 = Constraint(expr= m.x26 + m.x42 <= 0.5)
m.e179 = Constraint(expr= m.x27 + m.x43 <= 0.5)
m.e180 = Constraint(expr= m.x28 + m.x44 <= 0.5)
m.e181 = Constraint(expr= m.x29 + m.x45 <= 0.5)
m.e182 = Constraint(expr= m.x30 + m.x46 <= 0.5)
m.e183 = Constraint(expr= m.x31 + m.x47 <= 0.5)
m.e184 = Constraint(expr= m.x32 + m.x48 <= 0.5)
m.e185 = Constraint(expr= m.x17 - m.x33 >= -0.5)
m.e186 = Constraint(expr= m.x18 - m.x34 >= -0.5)
m.e187 = Constraint(expr= m.x19 - m.x35 >= -0.5)
m.e188 = Constraint(expr= m.x20 - m.x36 >= -0.5)
m.e189 = Constraint(expr= m.x21 - m.x37 >= -0.5)
m.e190 = Constraint(expr= m.x22 - m.x38 >= -0.5)
m.e191 = Constraint(expr= m.x23 - m.x39 >= -0.5)
m.e192 = Constraint(expr= m.x24 - m.x40 >= -0.5)
m.e193 = Constraint(expr= m.x25 - m.x41 >= -0.5)
m.e194 = Constraint(expr= m.x26 - m.x42 >= -0.5)
m.e195 = Constraint(expr= m.x27 - m.x43 >= -0.5)
m.e196 = Constraint(expr= m.x28 - m.x44 >= -0.5)
m.e197 = Constraint(expr= m.x29 - m.x45 >= -0.5)
m.e198 = Constraint(expr= m.x30 - m.x46 >= -0.5)
m.e199 = Constraint(expr= m.x31 - m.x47 >= -0.5)
m.e200 = Constraint(expr= m.x32 - m.x48 >= -0.5)
