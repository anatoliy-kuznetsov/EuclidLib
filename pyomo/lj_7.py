...
m.obj = Objective(sense=minimize, expr= ((m.x1 - m.x2)**2 + (m.x8 - m.x9)**2 +
    (m.x15 - m.x16)**2)**(-3) * (((m.x1 - m.x2)**2 + (m.x8 - m.x9)**2 + (m.x15
    - m.x16)**2)**(-3) - 2) + ((m.x1 - m.x3)**2 + (m.x8 - m.x10)**2 + (m.x15
    - m.x17)**2)**(-3) * (((m.x1 - m.x3)**2 + (m.x8 - m.x10)**2 + (m.x15 -
    m.x17)**2)**(-3) - 2) + ((m.x1 - m.x4)**2 + (m.x8 - m.x11)**2 + (m.x15 -
    m.x18)**2)**(-3) * (((m.x1 - m.x4)**2 + (m.x8 - m.x11)**2 + (m.x15 - m.x18)
    **2)**(-3) - 2) + ((m.x1 - m.x5)**2 + (m.x8 - m.x12)**2 + (m.x15 - m.x19)**
    2)**(-3) * (((m.x1 - m.x5)**2 + (m.x8 - m.x12)**2 + (m.x15 - m.x19)**2)**(
    -3) - 2) + ((m.x1 - m.x6)**2 + (m.x8 - m.x13)**2 + (m.x15 - m.x20)**2)**(-3)
    * (((m.x1 - m.x6)**2 + (m.x8 - m.x13)**2 + (m.x15 - m.x20)**2)**(-3) - 2)
    + ((m.x1 - m.x7)**2 + (m.x8 - m.x14)**2 + (m.x15 - m.x21)**2)**(-3) * (((
    m.x1 - m.x7)**2 + (m.x8 - m.x14)**2 + (m.x15 - m.x21)**2)**(-3) - 2) + ((
    m.x2 - m.x3)**2 + (m.x9 - m.x10)**2 + (m.x16 - m.x17)**2)**(-3) * (((m.x2
    - m.x3)**2 + (m.x9 - m.x10)**2 + (m.x16 - m.x17)**2)**(-3) - 2) + ((m.x2
    - m.x4)**2 + (m.x9 - m.x11)**2 + (m.x16 - m.x18)**2)**(-3) * (((m.x2 -
    m.x4)**2 + (m.x9 - m.x11)**2 + (m.x16 - m.x18)**2)**(-3) - 2) + ((m.x2 -
    m.x5)**2 + (m.x9 - m.x12)**2 + (m.x16 - m.x19)**2)**(-3) * (((m.x2 - m.x5)
    **2 + (m.x9 - m.x12)**2 + (m.x16 - m.x19)**2)**(-3) - 2) + ((m.x2 - m.x6)**
    2 + (m.x9 - m.x13)**2 + (m.x16 - m.x20)**2)**(-3) * (((m.x2 - m.x6)**2 + (
    m.x9 - m.x13)**2 + (m.x16 - m.x20)**2)**(-3) - 2) + ((m.x2 - m.x7)**2 + (
    m.x9 - m.x14)**2 + (m.x16 - m.x21)**2)**(-3) * (((m.x2 - m.x7)**2 + (m.x9
    - m.x14)**2 + (m.x16 - m.x21)**2)**(-3) - 2) + ((m.x3 - m.x4)**2 + (m.x10
    - m.x11)**2 + (m.x17 - m.x18)**2)**(-3) * (((m.x3 - m.x4)**2 + (m.x10 -
    m.x11)**2 + (m.x17 - m.x18)**2)**(-3) - 2) + ((m.x3 - m.x5)**2 + (m.x10 -
    m.x12)**2 + (m.x17 - m.x19)**2)**(-3) * (((m.x3 - m.x5)**2 + (m.x10 - m.x12)
    **2 + (m.x17 - m.x19)**2)**(-3) - 2) + ((m.x3 - m.x6)**2 + (m.x10 - m.x13)
    **2 + (m.x17 - m.x20)**2)**(-3) * (((m.x3 - m.x6)**2 + (m.x10 - m.x13)**2
    + (m.x17 - m.x20)**2)**(-3) - 2) + ((m.x3 - m.x7)**2 + (m.x10 - m.x14)**2
    + (m.x17 - m.x21)**2)**(-3) * (((m.x3 - m.x7)**2 + (m.x10 - m.x14)**2 + (
    m.x17 - m.x21)**2)**(-3) - 2) + ((m.x4 - m.x5)**2 + (m.x11 - m.x12)**2 + (
    m.x18 - m.x19)**2)**(-3) * (((m.x4 - m.x5)**2 + (m.x11 - m.x12)**2 + (m.x18
    - m.x19)**2)**(-3) - 2) + ((m.x4 - m.x6)**2 + (m.x11 - m.x13)**2 + (m.x18
    - m.x20)**2)**(-3) * (((m.x4 - m.x6)**2 + (m.x11 - m.x13)**2 + (m.x18 -
    m.x20)**2)**(-3) - 2) + ((m.x4 - m.x7)**2 + (m.x11 - m.x14)**2 + (m.x18 -
    m.x21)**2)**(-3) * (((m.x4 - m.x7)**2 + (m.x11 - m.x14)**2 + (m.x18 - m.x21)
    **2)**(-3) - 2) + ((m.x5 - m.x6)**2 + (m.x12 - m.x13)**2 + (m.x19 - m.x20)
    **2)**(-3) * (((m.x5 - m.x6)**2 + (m.x12 - m.x13)**2 + (m.x19 - m.x20)**2)
    **(-3) - 2) + ((m.x5 - m.x7)**2 + (m.x12 - m.x14)**2 + (m.x19 - m.x21)**2)
    **(-3) * (((m.x5 - m.x7)**2 + (m.x12 - m.x14)**2 + (m.x19 - m.x21)**2)**(-3)
    - 2) + ((m.x6 - m.x7)**2 + (m.x13 - m.x14)**2 + (m.x20 - m.x21)**2)**(-3)
    * (((m.x6 - m.x7)**2 + (m.x13 - m.x14)**2 + (m.x20 - m.x21)**2)**(-3) - 2))
