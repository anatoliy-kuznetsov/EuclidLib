...
m.e408 = Constraint(expr= m.x60 - m.x88 == 0)
m.e409 = Constraint(expr= m.x61 - m.x88 == 0)
m.e410 = Constraint(expr= m.x62 - m.x88 == 0)
m.e411 = Constraint(expr= m.x63 - m.x88 == 0)
m.e412 = Constraint(expr= m.x64 - m.x88 == 0)
m.e413 = Constraint(expr= m.x65 - m.x88 == 0)
m.e414 = Constraint(expr= m.x66 - m.x88 == 0)
m.e415 = Constraint(expr= m.x67 - m.x88 == 0)
m.e416 = Constraint(expr= m.x68 - m.x88 == 0)
m.e417 = Constraint(expr= m.x69 - m.x88 == 0)
m.e418 = Constraint(expr= m.x70 - m.x88 == 0)
m.e419 = Constraint(expr= m.x71 - m.x88 == 0)
m.e420 = Constraint(expr= m.x72 - m.x88 == 0)
m.e421 = Constraint(expr= m.x73 - m.x88 == 0)
m.e422 = Constraint(expr= m.x74 - m.x88 == 0)
m.e423 = Constraint(expr= m.x75 - m.x88 == 0)
m.e424 = Constraint(expr= m.x76 - m.x88 == 0)
m.e425 = Constraint(expr= m.x77 - m.x88 == 0)
m.e426 = Constraint(expr= m.x78 - m.x88 == 0)
m.e427 = Constraint(expr= m.x79 - m.x88 == 0)
m.e428 = Constraint(expr= m.x80 - m.x88 == 0)
m.e429 = Constraint(expr= m.x81 - m.x88 == 0)
m.e430 = Constraint(expr= m.x82 - m.x88 == 0)
m.e431 = Constraint(expr= m.x83 - m.x88 == 0)
m.e432 = Constraint(expr= m.x84 - m.x88 == 0)
m.e433 = Constraint(expr= m.x85 - m.x88 == 0)
m.e434 = Constraint(expr= m.x86 - m.x88 == 0)
m.e435 = Constraint(expr= m.x87 - m.x88 == 0)
m.e436 = Constraint(expr= m.x1 + m.x59 <= 0.5)
m.e437 = Constraint(expr= m.x2 + m.x60 <= 0.5)
m.e438 = Constraint(expr= m.x3 + m.x61 <= 0.5)
m.e439 = Constraint(expr= m.x4 + m.x62 <= 0.5)
m.e440 = Constraint(expr= m.x5 + m.x63 <= 0.5)
m.e441 = Constraint(expr= m.x6 + m.x64 <= 0.5)
m.e442 = Constraint(expr= m.x7 + m.x65 <= 0.5)
m.e443 = Constraint(expr= m.x8 + m.x66 <= 0.5)
m.e444 = Constraint(expr= m.x9 + m.x67 <= 0.5)
m.e445 = Constraint(expr= m.x10 + m.x68 <= 0.5)
m.e446 = Constraint(expr= m.x11 + m.x69 <= 0.5)
m.e447 = Constraint(expr= m.x12 + m.x70 <= 0.5)
m.e448 = Constraint(expr= m.x13 + m.x71 <= 0.5)
m.e449 = Constraint(expr= m.x14 + m.x72 <= 0.5)
m.e450 = Constraint(expr= m.x15 + m.x73 <= 0.5)
m.e451 = Constraint(expr= m.x16 + m.x74 <= 0.5)
m.e452 = Constraint(expr= m.x17 + m.x75 <= 0.5)
m.e453 = Constraint(expr= m.x18 + m.x76 <= 0.5)
m.e454 = Constraint(expr= m.x19 + m.x77 <= 0.5)
m.e455 = Constraint(expr= m.x20 + m.x78 <= 0.5)
m.e456 = Constraint(expr= m.x21 + m.x79 <= 0.5)
m.e457 = Constraint(expr= m.x22 + m.x80 <= 0.5)
m.e458 = Constraint(expr= m.x23 + m.x81 <= 0.5)
m.e459 = Constraint(expr= m.x24 + m.x82 <= 0.5)
m.e460 = Constraint(expr= m.x25 + m.x83 <= 0.5)
m.e461 = Constraint(expr= m.x26 + m.x84 <= 0.5)
m.e462 = Constraint(expr= m.x27 + m.x85 <= 0.5)
m.e463 = Constraint(expr= m.x28 + m.x86 <= 0.5)
m.e464 = Constraint(expr= m.x29 + m.x87 <= 0.5)
m.e465 = Constraint(expr= m.x1 - m.x59 >= -0.5)
m.e466 = Constraint(expr= m.x2 - m.x60 >= -0.5)
m.e467 = Constraint(expr= m.x3 - m.x61 >= -0.5)
m.e468 = Constraint(expr= m.x4 - m.x62 >= -0.5)
m.e469 = Constraint(expr= m.x5 - m.x63 >= -0.5)
m.e470 = Constraint(expr= m.x6 - m.x64 >= -0.5)
m.e471 = Constraint(expr= m.x7 - m.x65 >= -0.5)
m.e472 = Constraint(expr= m.x8 - m.x66 >= -0.5)
m.e473 = Constraint(expr= m.x9 - m.x67 >= -0.5)
m.e474 = Constraint(expr= m.x10 - m.x68 >= -0.5)
m.e475 = Constraint(expr= m.x11 - m.x69 >= -0.5)
m.e476 = Constraint(expr= m.x12 - m.x70 >= -0.5)
m.e477 = Constraint(expr= m.x13 - m.x71 >= -0.5)
m.e478 = Constraint(expr= m.x14 - m.x72 >= -0.5)
m.e479 = Constraint(expr= m.x15 - m.x73 >= -0.5)
m.e480 = Constraint(expr= m.x16 - m.x74 >= -0.5)
m.e481 = Constraint(expr= m.x17 - m.x75 >= -0.5)
m.e482 = Constraint(expr= m.x18 - m.x76 >= -0.5)
m.e483 = Constraint(expr= m.x19 - m.x77 >= -0.5)
m.e484 = Constraint(expr= m.x20 - m.x78 >= -0.5)
m.e485 = Constraint(expr= m.x21 - m.x79 >= -0.5)
m.e486 = Constraint(expr= m.x22 - m.x80 >= -0.5)
m.e487 = Constraint(expr= m.x23 - m.x81 >= -0.5)
m.e488 = Constraint(expr= m.x24 - m.x82 >= -0.5)
m.e489 = Constraint(expr= m.x25 - m.x83 >= -0.5)
m.e490 = Constraint(expr= m.x26 - m.x84 >= -0.5)
m.e491 = Constraint(expr= m.x27 - m.x85 >= -0.5)
m.e492 = Constraint(expr= m.x28 - m.x86 >= -0.5)
m.e493 = Constraint(expr= m.x29 - m.x87 >= -0.5)
m.e494 = Constraint(expr= m.x30 + m.x59 <= 0.5)
m.e495 = Constraint(expr= m.x31 + m.x60 <= 0.5)
m.e496 = Constraint(expr= m.x32 + m.x61 <= 0.5)
m.e497 = Constraint(expr= m.x33 + m.x62 <= 0.5)
m.e498 = Constraint(expr= m.x34 + m.x63 <= 0.5)
m.e499 = Constraint(expr= m.x35 + m.x64 <= 0.5)
m.e500 = Constraint(expr= m.x36 + m.x65 <= 0.5)
m.e501 = Constraint(expr= m.x37 + m.x66 <= 0.5)
m.e502 = Constraint(expr= m.x38 + m.x67 <= 0.5)
m.e503 = Constraint(expr= m.x39 + m.x68 <= 0.5)
m.e504 = Constraint(expr= m.x40 + m.x69 <= 0.5)
m.e505 = Constraint(expr= m.x41 + m.x70 <= 0.5)
m.e506 = Constraint(expr= m.x42 + m.x71 <= 0.5)
m.e507 = Constraint(expr= m.x43 + m.x72 <= 0.5)
m.e508 = Constraint(expr= m.x44 + m.x73 <= 0.5)
m.e509 = Constraint(expr= m.x45 + m.x74 <= 0.5)
m.e510 = Constraint(expr= m.x46 + m.x75 <= 0.5)
m.e511 = Constraint(expr= m.x47 + m.x76 <= 0.5)
m.e512 = Constraint(expr= m.x48 + m.x77 <= 0.5)
m.e513 = Constraint(expr= m.x49 + m.x78 <= 0.5)
m.e514 = Constraint(expr= m.x50 + m.x79 <= 0.5)
m.e515 = Constraint(expr= m.x51 + m.x80 <= 0.5)
m.e516 = Constraint(expr= m.x52 + m.x81 <= 0.5)
m.e517 = Constraint(expr= m.x53 + m.x82 <= 0.5)
m.e518 = Constraint(expr= m.x54 + m.x83 <= 0.5)
m.e519 = Constraint(expr= m.x55 + m.x84 <= 0.5)
m.e520 = Constraint(expr= m.x56 + m.x85 <= 0.5)
m.e521 = Constraint(expr= m.x57 + m.x86 <= 0.5)
m.e522 = Constraint(expr= m.x58 + m.x87 <= 0.5)
m.e523 = Constraint(expr= m.x30 - m.x59 >= -0.5)
m.e524 = Constraint(expr= m.x31 - m.x60 >= -0.5)
m.e525 = Constraint(expr= m.x32 - m.x61 >= -0.5)
m.e526 = Constraint(expr= m.x33 - m.x62 >= -0.5)
m.e527 = Constraint(expr= m.x34 - m.x63 >= -0.5)
m.e528 = Constraint(expr= m.x35 - m.x64 >= -0.5)
m.e529 = Constraint(expr= m.x36 - m.x65 >= -0.5)
m.e530 = Constraint(expr= m.x37 - m.x66 >= -0.5)
m.e531 = Constraint(expr= m.x38 - m.x67 >= -0.5)
m.e532 = Constraint(expr= m.x39 - m.x68 >= -0.5)
m.e533 = Constraint(expr= m.x40 - m.x69 >= -0.5)
m.e534 = Constraint(expr= m.x41 - m.x70 >= -0.5)
m.e535 = Constraint(expr= m.x42 - m.x71 >= -0.5)
m.e536 = Constraint(expr= m.x43 - m.x72 >= -0.5)
m.e537 = Constraint(expr= m.x44 - m.x73 >= -0.5)
m.e538 = Constraint(expr= m.x45 - m.x74 >= -0.5)
m.e539 = Constraint(expr= m.x46 - m.x75 >= -0.5)
m.e540 = Constraint(expr= m.x47 - m.x76 >= -0.5)
m.e541 = Constraint(expr= m.x48 - m.x77 >= -0.5)
m.e542 = Constraint(expr= m.x49 - m.x78 >= -0.5)
m.e543 = Constraint(expr= m.x50 - m.x79 >= -0.5)
m.e544 = Constraint(expr= m.x51 - m.x80 >= -0.5)
m.e545 = Constraint(expr= m.x52 - m.x81 >= -0.5)
m.e546 = Constraint(expr= m.x53 - m.x82 >= -0.5)
m.e547 = Constraint(expr= m.x54 - m.x83 >= -0.5)
m.e548 = Constraint(expr= m.x55 - m.x84 >= -0.5)
m.e549 = Constraint(expr= m.x56 - m.x85 >= -0.5)
m.e550 = Constraint(expr= m.x57 - m.x86 >= -0.5)
m.e551 = Constraint(expr= m.x58 - m.x87 >= -0.5)
