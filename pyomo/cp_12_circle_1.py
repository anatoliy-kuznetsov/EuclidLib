...
m.e68 = Constraint(expr= m.x26 - 2 * m.x37 == 0)
m.e69 = Constraint(expr= m.x27 - 3.0000000000000004 * m.x37 == 0)
m.e70 = Constraint(expr= m.x28 - 4 * m.x37 == 0)
m.e71 = Constraint(expr= m.x29 - 4.999999999999999 * m.x37 == 0)
m.e72 = Constraint(expr= m.x30 - 6 * m.x37 == 0)
m.e73 = Constraint(expr= m.x31 - 6.999999999999999 * m.x37 == 0)
m.e74 = Constraint(expr= m.x32 - 7.999999999999998 * m.x37 == 0)
m.e75 = Constraint(expr= m.x33 - 9.000000000000002 * m.x37 == 0)
m.e76 = Constraint(expr= m.x34 - 10.000000000000002 * m.x37 == 0)
m.e77 = Constraint(expr= m.x35 - 11.000000000000002 * m.x37 == 0)
m.e78 = Constraint(expr= m.x36 - 12 * m.x37 == 0)
