# NLP written by GAMS Convert at 05/15/24 11:38:54
#
# Equation counts
#     Total        E        G        L        N        X        C        B
#        10        0       10        0        0        0        0        0
...
m.obj = Objective(sense=minimize, expr= exp(-6 * sqrt((m.x1 - m.x2)**2 + (m.x6
    ...
    **2 + (m.x12 - m.x13)**2) + 6) - 2) + exp(-6 * sqrt((m.x2 - m.x4)**2 + (
    ...
    - m.x5)**2 + (m.x7 - m.x10)**2 + (m.x12 - m.x15)**2) + 6) * (exp(-6 *
    sqrt((m.x2 - m.x5)**2 + (m.x7 - m.x10)**2 + (m.x12 - m.x15)**2) + 6) - 2)
    + exp(-6 * sqrt((m.x3 - m.x4)**2 + (m.x8 - m.x9)**2 + (m.x13 - m.x14)**2)
    + 6) * (exp(-6 * sqrt((m.x3 - m.x4)**2 + (m.x8 - m.x9)**2 + (m.x13 - m.x14)
    **2) + 6) - 2) + exp(-6 * sqrt((m.x3 - m.x5)**2 + (m.x8 - m.x10)**2 + (
    m.x13 - m.x15)**2) + 6) * (exp(-6 * sqrt((m.x3 - m.x5)**2 + (m.x8 - m.x10)
    **2 + (m.x13 - m.x15)**2) + 6) - 2) + exp(-6 * sqrt((m.x4 - m.x5)**2 + (
    m.x9 - m.x10)**2 + (m.x14 - m.x15)**2) + 6) * (exp(-6 * sqrt((m.x4 - m.x5)
    **2 + (m.x9 - m.x10)**2 + (m.x14 - m.x15)**2) + 6) - 2))
