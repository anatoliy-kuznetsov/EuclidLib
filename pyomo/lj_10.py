...
m.obj = Objective(sense=minimize, expr= ((m.x1 - m.x2)**2 + (m.x11 - m.x12)**2
    + (m.x21 - m.x22)**2)**(-3) * (((m.x1 - m.x2)**2 + (m.x11 - m.x12)**2 + (
    m.x21 - m.x22)**2)**(-3) - 2) + ((m.x1 - m.x3)**2 + (m.x11 - m.x13)**2 + (
    m.x21 - m.x23)**2)**(-3) * (((m.x1 - m.x3)**2 + (m.x11 - m.x13)**2 + (m.x21
    - m.x23)**2)**(-3) - 2) + ((m.x1 - m.x4)**2 + (m.x11 - m.x14)**2 + (m.x21
    - m.x24)**2)**(-3) * (((m.x1 - m.x4)**2 + (m.x11 - m.x14)**2 + (m.x21 -
    m.x24)**2)**(-3) - 2) + ((m.x1 - m.x5)**2 + (m.x11 - m.x15)**2 + (m.x21 -
    m.x25)**2)**(-3) * (((m.x1 - m.x5)**2 + (m.x11 - m.x15)**2 + (m.x21 - m.x25)
    **2)**(-3) - 2) + ((m.x1 - m.x6)**2 + (m.x11 - m.x16)**2 + (m.x21 - m.x26)
    **2)**(-3) * (((m.x1 - m.x6)**2 + (m.x11 - m.x16)**2 + (m.x21 - m.x26)**2)
    **(-3) - 2) + ((m.x1 - m.x7)**2 + (m.x11 - m.x17)**2 + (m.x21 - m.x27)**2)
    **(-3) * (((m.x1 - m.x7)**2 + (m.x11 - m.x17)**2 + (m.x21 - m.x27)**2)**(-3)
    - 2) + ((m.x1 - m.x8)**2 + (m.x11 - m.x18)**2 + (m.x21 - m.x28)**2)**(-3)
    * (((m.x1 - m.x8)**2 + (m.x11 - m.x18)**2 + (m.x21 - m.x28)**2)**(-3) - 2)
    + ((m.x1 - m.x9)**2 + (m.x11 - m.x19)**2 + (m.x21 - m.x29)**2)**(-3) * (((
    m.x1 - m.x9)**2 + (m.x11 - m.x19)**2 + (m.x21 - m.x29)**2)**(-3) - 2) + ((
    m.x1 - m.x10)**2 + (m.x11 - m.x20)**2 + (m.x21 - m.x30)**2)**(-3) * (((m.x1
    - m.x10)**2 + (m.x11 - m.x20)**2 + (m.x21 - m.x30)**2)**(-3) - 2) + ((m.x2
    - m.x3)**2 + (m.x12 - m.x13)**2 + (m.x22 - m.x23)**2)**(-3) * (((m.x2 -
    m.x3)**2 + (m.x12 - m.x13)**2 + (m.x22 - m.x23)**2)**(-3) - 2) + ((m.x2 -
    m.x4)**2 + (m.x12 - m.x14)**2 + (m.x22 - m.x24)**2)**(-3) * (((m.x2 - m.x4)
    **2 + (m.x12 - m.x14)**2 + (m.x22 - m.x24)**2)**(-3) - 2) + ((m.x2 - m.x5)
    **2 + (m.x12 - m.x15)**2 + (m.x22 - m.x25)**2)**(-3) * (((m.x2 - m.x5)**2
    + (m.x12 - m.x15)**2 + (m.x22 - m.x25)**2)**(-3) - 2) + ((m.x2 - m.x6)**2
    + (m.x12 - m.x16)**2 + (m.x22 - m.x26)**2)**(-3) * (((m.x2 - m.x6)**2 + (
    m.x12 - m.x16)**2 + (m.x22 - m.x26)**2)**(-3) - 2) + ((m.x2 - m.x7)**2 + (
    m.x12 - m.x17)**2 + (m.x22 - m.x27)**2)**(-3) * (((m.x2 - m.x7)**2 + (m.x12
    - m.x17)**2 + (m.x22 - m.x27)**2)**(-3) - 2) + ((m.x2 - m.x8)**2 + (m.x12
    - m.x18)**2 + (m.x22 - m.x28)**2)**(-3) * (((m.x2 - m.x8)**2 + (m.x12 -
    m.x18)**2 + (m.x22 - m.x28)**2)**(-3) - 2) + ((m.x2 - m.x9)**2 + (m.x12 -
    m.x19)**2 + (m.x22 - m.x29)**2)**(-3) * (((m.x2 - m.x9)**2 + (m.x12 - m.x19)
    **2 + (m.x22 - m.x29)**2)**(-3) - 2) + ((m.x2 - m.x10)**2 + (m.x12 - m.x20)
    **2 + (m.x22 - m.x30)**2)**(-3) * (((m.x2 - m.x10)**2 + (m.x12 - m.x20)**2
    + (m.x22 - m.x30)**2)**(-3) - 2) + ((m.x3 - m.x4)**2 + (m.x13 - m.x14)**2
    + (m.x23 - m.x24)**2)**(-3) * (((m.x3 - m.x4)**2 + (m.x13 - m.x14)**2 + (
    m.x23 - m.x24)**2)**(-3) - 2) + ((m.x3 - m.x5)**2 + (m.x13 - m.x15)**2 + (
    m.x23 - m.x25)**2)**(-3) * (((m.x3 - m.x5)**2 + (m.x13 - m.x15)**2 + (m.x23
    - m.x25)**2)**(-3) - 2) + ((m.x3 - m.x6)**2 + (m.x13 - m.x16)**2 + (m.x23
    - m.x26)**2)**(-3) * (((m.x3 - m.x6)**2 + (m.x13 - m.x16)**2 + (m.x23 -
    m.x26)**2)**(-3) - 2) + ((m.x3 - m.x7)**2 + (m.x13 - m.x17)**2 + (m.x23 -
    m.x27)**2)**(-3) * (((m.x3 - m.x7)**2 + (m.x13 - m.x17)**2 + (m.x23 - m.x27)
    **2)**(-3) - 2) + ((m.x3 - m.x8)**2 + (m.x13 - m.x18)**2 + (m.x23 - m.x28)
    **2)**(-3) * (((m.x3 - m.x8)**2 + (m.x13 - m.x18)**2 + (m.x23 - m.x28)**2)
    **(-3) - 2) + ((m.x3 - m.x9)**2 + (m.x13 - m.x19)**2 + (m.x23 - m.x29)**2)
    **(-3) * (((m.x3 - m.x9)**2 + (m.x13 - m.x19)**2 + (m.x23 - m.x29)**2)**(-3)
    - 2) + ((m.x3 - m.x10)**2 + (m.x13 - m.x20)**2 + (m.x23 - m.x30)**2)**(-3)
    * (((m.x3 - m.x10)**2 + (m.x13 - m.x20)**2 + (m.x23 - m.x30)**2)**(-3) - 2)
    + ((m.x4 - m.x5)**2 + (m.x14 - m.x15)**2 + (m.x24 - m.x25)**2)**(-3) * (((
    m.x4 - m.x5)**2 + (m.x14 - m.x15)**2 + (m.x24 - m.x25)**2)**(-3) - 2) + ((
    m.x4 - m.x6)**2 + (m.x14 - m.x16)**2 + (m.x24 - m.x26)**2)**(-3) * (((m.x4
    - m.x6)**2 + (m.x14 - m.x16)**2 + (m.x24 - m.x26)**2)**(-3) - 2) + ((m.x4
    - m.x7)**2 + (m.x14 - m.x17)**2 + (m.x24 - m.x27)**2)**(-3) * (((m.x4 -
    m.x7)**2 + (m.x14 - m.x17)**2 + (m.x24 - m.x27)**2)**(-3) - 2) + ((m.x4 -
    m.x8)**2 + (m.x14 - m.x18)**2 + (m.x24 - m.x28)**2)**(-3) * (((m.x4 - m.x8)
    **2 + (m.x14 - m.x18)**2 + (m.x24 - m.x28)**2)**(-3) - 2) + ((m.x4 - m.x9)
    **2 + (m.x14 - m.x19)**2 + (m.x24 - m.x29)**2)**(-3) * (((m.x4 - m.x9)**2
    + (m.x14 - m.x19)**2 + (m.x24 - m.x29)**2)**(-3) - 2) + ((m.x4 - m.x10)**2
    + (m.x14 - m.x20)**2 + (m.x24 - m.x30)**2)**(-3) * (((m.x4 - m.x10)**2 + (
    m.x14 - m.x20)**2 + (m.x24 - m.x30)**2)**(-3) - 2) + ((m.x5 - m.x6)**2 + (
    m.x15 - m.x16)**2 + (m.x25 - m.x26)**2)**(-3) * (((m.x5 - m.x6)**2 + (m.x15
    - m.x16)**2 + (m.x25 - m.x26)**2)**(-3) - 2) + ((m.x5 - m.x7)**2 + (m.x15
    - m.x17)**2 + (m.x25 - m.x27)**2)**(-3) * (((m.x5 - m.x7)**2 + (m.x15 -
    m.x17)**2 + (m.x25 - m.x27)**2)**(-3) - 2) + ((m.x5 - m.x8)**2 + (m.x15 -
    m.x18)**2 + (m.x25 - m.x28)**2)**(-3) * (((m.x5 - m.x8)**2 + (m.x15 - m.x18)
    **2 + (m.x25 - m.x28)**2)**(-3) - 2) + ((m.x5 - m.x9)**2 + (m.x15 - m.x19)
    **2 + (m.x25 - m.x29)**2)**(-3) * (((m.x5 - m.x9)**2 + (m.x15 - m.x19)**2
    + (m.x25 - m.x29)**2)**(-3) - 2) + ((m.x5 - m.x10)**2 + (m.x15 - m.x20)**2
    + (m.x25 - m.x30)**2)**(-3) * (((m.x5 - m.x10)**2 + (m.x15 - m.x20)**2 + (
    m.x25 - m.x30)**2)**(-3) - 2) + ((m.x6 - m.x7)**2 + (m.x16 - m.x17)**2 + (
    m.x26 - m.x27)**2)**(-3) * (((m.x6 - m.x7)**2 + (m.x16 - m.x17)**2 + (m.x26
    - m.x27)**2)**(-3) - 2) + ((m.x6 - m.x8)**2 + (m.x16 - m.x18)**2 + (m.x26
    - m.x28)**2)**(-3) * (((m.x6 - m.x8)**2 + (m.x16 - m.x18)**2 + (m.x26 -
    m.x28)**2)**(-3) - 2) + ((m.x6 - m.x9)**2 + (m.x16 - m.x19)**2 + (m.x26 -
    m.x29)**2)**(-3) * (((m.x6 - m.x9)**2 + (m.x16 - m.x19)**2 + (m.x26 - m.x29)
    **2)**(-3) - 2) + ((m.x6 - m.x10)**2 + (m.x16 - m.x20)**2 + (m.x26 - m.x30)
    **2)**(-3) * (((m.x6 - m.x10)**2 + (m.x16 - m.x20)**2 + (m.x26 - m.x30)**2)
    **(-3) - 2) + ((m.x7 - m.x8)**2 + (m.x17 - m.x18)**2 + (m.x27 - m.x28)**2)
    **(-3) * (((m.x7 - m.x8)**2 + (m.x17 - m.x18)**2 + (m.x27 - m.x28)**2)**(-3)
    - 2) + ((m.x7 - m.x9)**2 + (m.x17 - m.x19)**2 + (m.x27 - m.x29)**2)**(-3)
    * (((m.x7 - m.x9)**2 + (m.x17 - m.x19)**2 + (m.x27 - m.x29)**2)**(-3) - 2)
    + ((m.x7 - m.x10)**2 + (m.x17 - m.x20)**2 + (m.x27 - m.x30)**2)**(-3) * ((
    (m.x7 - m.x10)**2 + (m.x17 - m.x20)**2 + (m.x27 - m.x30)**2)**(-3) - 2) + (
    (m.x8 - m.x9)**2 + (m.x18 - m.x19)**2 + (m.x28 - m.x29)**2)**(-3) * (((m.x8
    - m.x9)**2 + (m.x18 - m.x19)**2 + (m.x28 - m.x29)**2)**(-3) - 2) + ((m.x8
    - m.x10)**2 + (m.x18 - m.x20)**2 + (m.x28 - m.x30)**2)**(-3) * (((m.x8 -
    m.x10)**2 + (m.x18 - m.x20)**2 + (m.x28 - m.x30)**2)**(-3) - 2) + ((m.x9 -
    m.x10)**2 + (m.x19 - m.x20)**2 + (m.x29 - m.x30)**2)**(-3) * (((m.x9 -
    m.x10)**2 + (m.x19 - m.x20)**2 + (m.x29 - m.x30)**2)**(-3) - 2))
