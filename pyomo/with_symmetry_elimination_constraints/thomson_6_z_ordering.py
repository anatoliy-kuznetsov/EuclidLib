...
m.x13 = Var(within=Reals, bounds=(1,1), initialize=1)
...
m.e7 = Constraint(expr= m.x13 - m.x14 >= 0)
m.e8 = Constraint(expr= m.x14 - m.x15 >= 0)
m.e9 = Constraint(expr= m.x15 - m.x16 >= 0)
m.e10 = Constraint(expr= m.x16 - m.x17 >= 0)
m.e11 = Constraint(expr= m.x17 - m.x18 >= 0)
