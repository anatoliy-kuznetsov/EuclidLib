...
m.e3 = Constraint(expr= m.x1 + m.x5 <= 0.5)
m.e4 = Constraint(expr= m.x2 + m.x5 <= 0.5)
m.e5 = Constraint(expr= m.x1 - m.x5 >= -0.5)
m.e6 = Constraint(expr= m.x2 - m.x5 >= -0.5)
m.e7 = Constraint(expr= m.x3 + m.x5 <= 0.5)
m.e8 = Constraint(expr= m.x4 + m.x5 <= 0.5)
m.e9 = Constraint(expr= m.x3 - m.x5 >= -0.5)
m.e10 = Constraint(expr= m.x4 - m.x5 >= -0.5)
