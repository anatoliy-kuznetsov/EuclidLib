...
m.e400 = Constraint(expr= -(-0.37763 + m.x4)**2 - (-0.50093 + m.x8)**2 + m.x9
    <= 0)
m.e401 = Constraint(expr= -(m.x1 - m.x2)**2 - (m.x5 - m.x6)**2 <= -0.125)
m.e402 = Constraint(expr= -(m.x1 - m.x3)**2 - (m.x5 - m.x7)**2 <= -0.125)
m.e403 = Constraint(expr= -(m.x1 - m.x4)**2 - (m.x5 - m.x8)**2 <= -0.125)
m.e404 = Constraint(expr= -(m.x2 - m.x3)**2 - (m.x6 - m.x7)**2 <= -0.125)
m.e405 = Constraint(expr= -(m.x2 - m.x4)**2 - (m.x6 - m.x8)**2 <= -0.125)
m.e406 = Constraint(expr= -(m.x3 - m.x4)**2 - (m.x7 - m.x8)**2 <= -0.125)
