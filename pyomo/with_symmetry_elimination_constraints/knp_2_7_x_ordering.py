...
m.e22 = Constraint(expr= m.x1 - m.x3 <= 0)
m.e23 = Constraint(expr= m.x3 - m.x5 <= 0)
m.e24 = Constraint(expr= m.x5 - m.x7 <= 0)
m.e25 = Constraint(expr= m.x7 - m.x9 <= 0)
m.e26 = Constraint(expr= m.x9 - m.x11 <= 0)
m.e27 = Constraint(expr= m.x11 - m.x13 <= 0)
m.e28 = Constraint(expr= m.x1**2 + m.x2**2 == 4)
m.e29 = Constraint(expr= m.x3**2 + m.x4**2 == 4)
m.e30 = Constraint(expr= m.x5**2 + m.x6**2 == 4)
m.e31 = Constraint(expr= m.x7**2 + m.x8**2 == 4)
m.e32 = Constraint(expr= m.x9**2 + m.x10**2 == 4)
m.e33 = Constraint(expr= m.x11**2 + m.x12**2 == 4)
m.e34 = Constraint(expr= m.x13**2 + m.x14**2 == 4)
