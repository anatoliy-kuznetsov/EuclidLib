...
m.e936 = Constraint(expr= -(m.x8 - m.x9)**2 - (m.x17 - m.x18)**2
    <= -0.1111111111111111)
m.e937 = Constraint(expr= m.x1 - m.x2 <= 0)
m.e938 = Constraint(expr= m.x2 - m.x3 <= 0)
m.e939 = Constraint(expr= m.x3 - m.x4 <= 0)
m.e940 = Constraint(expr= m.x4 - m.x5 <= 0)
m.e941 = Constraint(expr= m.x5 - m.x6 <= 0)
m.e942 = Constraint(expr= m.x6 - m.x7 <= 0)
m.e943 = Constraint(expr= m.x7 - m.x8 <= 0)
m.e944 = Constraint(expr= m.x8 - m.x9 <= 0)
