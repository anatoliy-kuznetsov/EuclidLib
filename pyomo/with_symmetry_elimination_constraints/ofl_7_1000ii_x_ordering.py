...
m.e7021 = Constraint(expr= -(m.x6 - m.x7)**2 - (m.x13 - m.x14)**2
    <= -0.14285714285714285)
m.e7022 = Constraint(expr= m.x1 - m.x2 <= 0)
m.e7023 = Constraint(expr= m.x2 - m.x3 <= 0)
m.e7024 = Constraint(expr= m.x3 - m.x4 <= 0)
m.e7025 = Constraint(expr= m.x4 - m.x5 <= 0)
m.e7026 = Constraint(expr= m.x5 - m.x6 <= 0)
m.e7027 = Constraint(expr= m.x6 - m.x7 <= 0)
