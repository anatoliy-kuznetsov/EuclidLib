...
m.e21 = Constraint(expr= m.x1**2 + m.x7**2 - (1 - m.x13)**2 <= 0)
m.e22 = Constraint(expr= m.x2**2 + m.x8**2 - (1 - m.x13)**2 <= 0)
m.e23 = Constraint(expr= m.x3**2 + m.x9**2 - (1 - m.x13)**2 <= 0)
m.e24 = Constraint(expr= m.x4**2 + m.x10**2 - (1 - m.x13)**2 <= 0)
m.e25 = Constraint(expr= m.x5**2 + m.x11**2 - (1 - m.x13)**2 <= 0)
m.e26 = Constraint(expr= m.x6**2 + m.x12**2 - (1 - m.x13)**2 <= 0)
