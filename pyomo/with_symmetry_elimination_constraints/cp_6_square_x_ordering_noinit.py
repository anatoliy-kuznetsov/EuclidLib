...
m.e21 = Constraint(expr= m.x1 + m.x13 <= 0.5)
m.e22 = Constraint(expr= m.x2 + m.x13 <= 0.5)
m.e23 = Constraint(expr= m.x3 + m.x13 <= 0.5)
m.e24 = Constraint(expr= m.x4 + m.x13 <= 0.5)
m.e25 = Constraint(expr= m.x5 + m.x13 <= 0.5)
m.e26 = Constraint(expr= m.x6 + m.x13 <= 0.5)
m.e27 = Constraint(expr= m.x1 - m.x13 >= -0.5)
m.e28 = Constraint(expr= m.x2 - m.x13 >= -0.5)
m.e29 = Constraint(expr= m.x3 - m.x13 >= -0.5)
m.e30 = Constraint(expr= m.x4 - m.x13 >= -0.5)
m.e31 = Constraint(expr= m.x5 - m.x13 >= -0.5)
m.e32 = Constraint(expr= m.x6 - m.x13 >= -0.5)
m.e33 = Constraint(expr= m.x7 + m.x13 <= 0.5)
m.e34 = Constraint(expr= m.x8 + m.x13 <= 0.5)
m.e35 = Constraint(expr= m.x9 + m.x13 <= 0.5)
m.e36 = Constraint(expr= m.x10 + m.x13 <= 0.5)
m.e37 = Constraint(expr= m.x11 + m.x13 <= 0.5)
m.e38 = Constraint(expr= m.x12 + m.x13 <= 0.5)
m.e39 = Constraint(expr= m.x7 - m.x13 >= -0.5)
m.e40 = Constraint(expr= m.x8 - m.x13 >= -0.5)
m.e41 = Constraint(expr= m.x9 - m.x13 >= -0.5)
m.e42 = Constraint(expr= m.x10 - m.x13 >= -0.5)
m.e43 = Constraint(expr= m.x11 - m.x13 >= -0.5)
m.e44 = Constraint(expr= m.x12 - m.x13 >= -0.5)
