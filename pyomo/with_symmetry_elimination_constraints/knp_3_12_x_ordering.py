...
m.e66 = Constraint(expr= (m.x31 - m.x34)**2 + (m.x32 - m.x35)**2 + (m.x33 -
    m.x36)**2 - m.x37 >= 0)
m.e67 = Constraint(expr= m.x1 - m.x4 <= 0)
m.e68 = Constraint(expr= m.x4 - m.x7 <= 0)
m.e69 = Constraint(expr= m.x7 - m.x10 <= 0)
m.e70 = Constraint(expr= m.x10 - m.x13 <= 0)
m.e71 = Constraint(expr= m.x13 - m.x16 <= 0)
m.e72 = Constraint(expr= m.x16 - m.x19 <= 0)
m.e73 = Constraint(expr= m.x19 - m.x22 <= 0)
m.e74 = Constraint(expr= m.x22 - m.x25 <= 0)
m.e75 = Constraint(expr= m.x25 - m.x28 <= 0)
m.e76 = Constraint(expr= m.x28 - m.x31 <= 0)
m.e77 = Constraint(expr= m.x31 - m.x34 <= 0)
m.e78 = Constraint(expr= m.x1**2 + m.x2**2 + m.x3**2 == 4)
m.e79 = Constraint(expr= m.x4**2 + m.x5**2 + m.x6**2 == 4)
m.e80 = Constraint(expr= m.x7**2 + m.x8**2 + m.x9**2 == 4)
m.e81 = Constraint(expr= m.x10**2 + m.x11**2 + m.x12**2 == 4)
m.e82 = Constraint(expr= m.x13**2 + m.x14**2 + m.x15**2 == 4)
m.e83 = Constraint(expr= m.x16**2 + m.x17**2 + m.x18**2 == 4)
m.e84 = Constraint(expr= m.x19**2 + m.x20**2 + m.x21**2 == 4)
m.e85 = Constraint(expr= m.x22**2 + m.x23**2 + m.x24**2 == 4)
m.e86 = Constraint(expr= m.x25**2 + m.x26**2 + m.x27**2 == 4)
m.e87 = Constraint(expr= m.x28**2 + m.x29**2 + m.x30**2 == 4)
m.e88 = Constraint(expr= m.x31**2 + m.x32**2 + m.x33**2 == 4)
m.e89 = Constraint(expr= m.x34**2 + m.x35**2 + m.x36**2 == 4)
