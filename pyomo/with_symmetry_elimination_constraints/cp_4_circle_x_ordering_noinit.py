...
m.e10 = Constraint(expr= m.x1**2 + m.x5**2 - (1 - m.x9)**2 <= 0)
m.e11 = Constraint(expr= m.x2**2 + m.x6**2 - (1 - m.x9)**2 <= 0)
m.e12 = Constraint(expr= m.x3**2 + m.x7**2 - (1 - m.x9)**2 <= 0)
m.e13 = Constraint(expr= m.x4**2 + m.x8**2 - (1 - m.x9)**2 <= 0)
