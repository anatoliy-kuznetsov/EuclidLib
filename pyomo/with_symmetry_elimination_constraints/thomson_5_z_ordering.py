...
m.x11 = Var(within=Reals, bounds=(1,1), initialize=1)
...
m.obj = Objective(sense=minimize, expr= 1 / sqrt((m.x1 - m.x2)**2 + (m.x6 -
    m.x7)**2 + (m.x11 - m.x12)**2) + 1 / sqrt((m.x1 - m.x3)**2 + (m.x6 - m.x8)
    **2 + (m.x11 - m.x13)**2) + 1 / sqrt((m.x1 - m.x4)**2 + (m.x6 - m.x9)**2 +
    (m.x11 - m.x14)**2) + 1 / sqrt((m.x1 - m.x5)**2 + (m.x6 - m.x10)**2 + (
    m.x11 - m.x15)**2) + 1 / sqrt((m.x2 - m.x3)**2 + (m.x7 - m.x8)**2 + (m.x12
    - m.x13)**2) + 1 / sqrt((m.x2 - m.x4)**2 + (m.x7 - m.x9)**2 + (m.x12 -
    m.x14)**2) + 1 / sqrt((m.x2 - m.x5)**2 + (m.x7 - m.x10)**2 + (m.x12 - m.x15)
    **2) + 1 / sqrt((m.x3 - m.x4)**2 + (m.x8 - m.x9)**2 + (m.x13 - m.x14)**2)
    + 1 / sqrt((m.x3 - m.x5)**2 + (m.x8 - m.x10)**2 + (m.x13 - m.x15)**2) + 1
    / sqrt((m.x4 - m.x5)**2 + (m.x9 - m.x10)**2 + (m.x14 - m.x15)**2))
...
m.e6 = Constraint(expr= m.x11 - m.x12 >= 0)
m.e7 = Constraint(expr= m.x12 - m.x13 >= 0)
m.e8 = Constraint(expr= m.x13 - m.x14 >= 0)
m.e9 = Constraint(expr= m.x14 - m.x15 >= 0)
