...
m.e721 = Constraint(expr= -(m.x6 - m.x7)**2 - (m.x13 - m.x14)**2
    <= -0.14285714285714285)
m.e722 = Constraint(expr= m.x1 - m.x2 <= 0)
m.e723 = Constraint(expr= m.x2 - m.x3 <= 0)
m.e724 = Constraint(expr= m.x3 - m.x4 <= 0)
m.e725 = Constraint(expr= m.x4 - m.x5 <= 0)
m.e726 = Constraint(expr= m.x5 - m.x6 <= 0)
m.e727 = Constraint(expr= m.x6 - m.x7 <= 0)
