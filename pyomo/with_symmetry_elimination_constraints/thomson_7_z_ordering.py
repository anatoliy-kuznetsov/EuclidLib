...
m.x15 = Var(within=Reals, bounds=(1,1), initialize=1)
...
m.e8 = Constraint(expr= m.x15 - m.x16 >= 0)
m.e9 = Constraint(expr= m.x16 - m.x17 >= 0)
m.e10 = Constraint(expr= m.x17 - m.x18 >= 0)
m.e11 = Constraint(expr= m.x18 - m.x19 >= 0)
m.e12 = Constraint(expr= m.x19 - m.x20 >= 0)
m.e13 = Constraint(expr= m.x20 - m.x21 >= 0)
