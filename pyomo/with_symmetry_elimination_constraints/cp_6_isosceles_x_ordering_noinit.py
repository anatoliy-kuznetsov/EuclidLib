...
m.e21 = Constraint(expr= m.x1 - m.x13 >= 0)
m.e22 = Constraint(expr= m.x2 - m.x13 >= 0)
m.e23 = Constraint(expr= m.x3 - m.x13 >= 0)
m.e24 = Constraint(expr= m.x4 - m.x13 >= 0)
m.e25 = Constraint(expr= m.x5 - m.x13 >= 0)
m.e26 = Constraint(expr= m.x6 - m.x13 >= 0)
m.e27 = Constraint(expr= m.x7 - m.x13 >= 0)
m.e28 = Constraint(expr= m.x8 - m.x13 >= 0)
m.e29 = Constraint(expr= m.x9 - m.x13 >= 0)
m.e30 = Constraint(expr= m.x10 - m.x13 >= 0)
m.e31 = Constraint(expr= m.x11 - m.x13 >= 0)
m.e32 = Constraint(expr= m.x12 - m.x13 >= 0)
m.e33 = Constraint(expr= -0.7071067811865475 * m.x1 - 0.7071067811865475 * m.x7
    - m.x13 >= -0.7071067811865475)
m.e34 = Constraint(expr= -0.7071067811865475 * m.x2 - 0.7071067811865475 * m.x8
    - m.x13 >= -0.7071067811865475)
m.e35 = Constraint(expr= -0.7071067811865475 * m.x3 - 0.7071067811865475 * m.x9
    - m.x13 >= -0.7071067811865475)
m.e36 = Constraint(expr= -0.7071067811865475 * m.x4 - 0.7071067811865475 *
    m.x10 - m.x13 >= -0.7071067811865475)
m.e37 = Constraint(expr= -0.7071067811865475 * m.x5 - 0.7071067811865475 *
    m.x11 - m.x13 >= -0.7071067811865475)
m.e38 = Constraint(expr= -0.7071067811865475 * m.x6 - 0.7071067811865475 *
