...
m.obj = Objective(sense=minimize, expr= exp(-14 * sqrt((m.x1 - m.x2)**2 + (m.x7
    - m.x8)**2 + (m.x13 - m.x14)**2) + 14) * (exp(-14 * sqrt((m.x1 - m.x2)**2
    + (m.x7 - m.x8)**2 + (m.x13 - m.x14)**2) + 14) - 2) + exp(-14 * sqrt((m.x1
    - m.x3)**2 + (m.x7 - m.x9)**2 + (m.x13 - m.x15)**2) + 14) * (exp(-14 *
    sqrt((m.x1 - m.x3)**2 + (m.x7 - m.x9)**2 + (m.x13 - m.x15)**2) + 14) - 2)
    + exp(-14 * sqrt((m.x1 - m.x4)**2 + (m.x7 - m.x10)**2 + (m.x13 - m.x16)**2)
    + 14) * (exp(-14 * sqrt((m.x1 - m.x4)**2 + (m.x7 - m.x10)**2 + (m.x13 -
    m.x16)**2) + 14) - 2) + exp(-14 * sqrt((m.x1 - m.x5)**2 + (m.x7 - m.x11)**2
    + (m.x13 - m.x17)**2) + 14) * (exp(-14 * sqrt((m.x1 - m.x5)**2 + (m.x7 -
    m.x11)**2 + (m.x13 - m.x17)**2) + 14) - 2) + exp(-14 * sqrt((m.x1 - m.x6)**
    2 + (m.x7 - m.x12)**2 + (m.x13 - m.x18)**2) + 14) * (exp(-14 * sqrt((m.x1
    - m.x6)**2 + (m.x7 - m.x12)**2 + (m.x13 - m.x18)**2) + 14) - 2) + exp(-14
    * sqrt((m.x2 - m.x3)**2 + (m.x8 - m.x9)**2 + (m.x14 - m.x15)**2) + 14) * (
    exp(-14 * sqrt((m.x2 - m.x3)**2 + (m.x8 - m.x9)**2 + (m.x14 - m.x15)**2) +
    14) - 2) + exp(-14 * sqrt((m.x2 - m.x4)**2 + (m.x8 - m.x10)**2 + (m.x14 -
    m.x16)**2) + 14) * (exp(-14 * sqrt((m.x2 - m.x4)**2 + (m.x8 - m.x10)**2 + (
    m.x14 - m.x16)**2) + 14) - 2) + exp(-14 * sqrt((m.x2 - m.x5)**2 + (m.x8 -
    m.x11)**2 + (m.x14 - m.x17)**2) + 14) * (exp(-14 * sqrt((m.x2 - m.x5)**2 +
    (m.x8 - m.x11)**2 + (m.x14 - m.x17)**2) + 14) - 2) + exp(-14 * sqrt((m.x2
    - m.x6)**2 + (m.x8 - m.x12)**2 + (m.x14 - m.x18)**2) + 14) * (exp(-14 *
    sqrt((m.x2 - m.x6)**2 + (m.x8 - m.x12)**2 + (m.x14 - m.x18)**2) + 14) - 2)
    + exp(-14 * sqrt((m.x3 - m.x4)**2 + (m.x9 - m.x10)**2 + (m.x15 - m.x16)**2)
    + 14) * (exp(-14 * sqrt((m.x3 - m.x4)**2 + (m.x9 - m.x10)**2 + (m.x15 -
    m.x16)**2) + 14) - 2) + exp(-14 * sqrt((m.x3 - m.x5)**2 + (m.x9 - m.x11)**2
    + (m.x15 - m.x17)**2) + 14) * (exp(-14 * sqrt((m.x3 - m.x5)**2 + (m.x9 -
    m.x11)**2 + (m.x15 - m.x17)**2) + 14) - 2) + exp(-14 * sqrt((m.x3 - m.x6)**
    2 + (m.x9 - m.x12)**2 + (m.x15 - m.x18)**2) + 14) * (exp(-14 * sqrt((m.x3
    - m.x6)**2 + (m.x9 - m.x12)**2 + (m.x15 - m.x18)**2) + 14) - 2) + exp(-14
    * sqrt((m.x4 - m.x5)**2 + (m.x10 - m.x11)**2 + (m.x16 - m.x17)**2) + 14)
    * (exp(-14 * sqrt((m.x4 - m.x5)**2 + (m.x10 - m.x11)**2 + (m.x16 - m.x17)
    **2) + 14) - 2) + exp(-14 * sqrt((m.x4 - m.x6)**2 + (m.x10 - m.x12)**2 + (
    m.x16 - m.x18)**2) + 14) * (exp(-14 * sqrt((m.x4 - m.x6)**2 + (m.x10 -
    m.x12)**2 + (m.x16 - m.x18)**2) + 14) - 2) + exp(-14 * sqrt((m.x5 - m.x6)**
    2 + (m.x11 - m.x12)**2 + (m.x17 - m.x18)**2) + 14) * (exp(-14 * sqrt((m.x5
    - m.x6)**2 + (m.x11 - m.x12)**2 + (m.x17 - m.x18)**2) + 14) - 2))
