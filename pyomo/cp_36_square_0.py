...
m.e667 = Constraint(expr= m.x1 + m.x73 <= 0.5)
m.e668 = Constraint(expr= m.x2 + m.x74 <= 0.5)
m.e669 = Constraint(expr= m.x3 + m.x75 <= 0.5)
m.e670 = Constraint(expr= m.x4 + m.x76 <= 0.5)
m.e671 = Constraint(expr= m.x5 + m.x77 <= 0.5)
m.e672 = Constraint(expr= m.x6 + m.x78 <= 0.5)
m.e673 = Constraint(expr= m.x7 + m.x79 <= 0.5)
m.e674 = Constraint(expr= m.x8 + m.x80 <= 0.5)
m.e675 = Constraint(expr= m.x9 + m.x81 <= 0.5)
m.e676 = Constraint(expr= m.x10 + m.x82 <= 0.5)
m.e677 = Constraint(expr= m.x11 + m.x83 <= 0.5)
m.e678 = Constraint(expr= m.x12 + m.x84 <= 0.5)
m.e679 = Constraint(expr= m.x13 + m.x85 <= 0.5)
m.e680 = Constraint(expr= m.x14 + m.x86 <= 0.5)
m.e681 = Constraint(expr= m.x15 + m.x87 <= 0.5)
m.e682 = Constraint(expr= m.x16 + m.x88 <= 0.5)
m.e683 = Constraint(expr= m.x17 + m.x89 <= 0.5)
m.e684 = Constraint(expr= m.x18 + m.x90 <= 0.5)
m.e685 = Constraint(expr= m.x19 + m.x91 <= 0.5)
m.e686 = Constraint(expr= m.x20 + m.x92 <= 0.5)
m.e687 = Constraint(expr= m.x21 + m.x93 <= 0.5)
m.e688 = Constraint(expr= m.x22 + m.x94 <= 0.5)
m.e689 = Constraint(expr= m.x23 + m.x95 <= 0.5)
m.e690 = Constraint(expr= m.x24 + m.x96 <= 0.5)
m.e691 = Constraint(expr= m.x25 + m.x97 <= 0.5)
m.e692 = Constraint(expr= m.x26 + m.x98 <= 0.5)
m.e693 = Constraint(expr= m.x27 + m.x99 <= 0.5)
m.e694 = Constraint(expr= m.x28 + m.x100 <= 0.5)
m.e695 = Constraint(expr= m.x29 + m.x101 <= 0.5)
m.e696 = Constraint(expr= m.x30 + m.x102 <= 0.5)
m.e697 = Constraint(expr= m.x31 + m.x103 <= 0.5)
m.e698 = Constraint(expr= m.x32 + m.x104 <= 0.5)
m.e699 = Constraint(expr= m.x33 + m.x105 <= 0.5)
m.e700 = Constraint(expr= m.x34 + m.x106 <= 0.5)
m.e701 = Constraint(expr= m.x35 + m.x107 <= 0.5)
m.e702 = Constraint(expr= m.x36 + m.x108 <= 0.5)
m.e703 = Constraint(expr= m.x1 - m.x73 >= -0.5)
m.e704 = Constraint(expr= m.x2 - m.x74 >= -0.5)
m.e705 = Constraint(expr= m.x3 - m.x75 >= -0.5)
m.e706 = Constraint(expr= m.x4 - m.x76 >= -0.5)
m.e707 = Constraint(expr= m.x5 - m.x77 >= -0.5)
m.e708 = Constraint(expr= m.x6 - m.x78 >= -0.5)
m.e709 = Constraint(expr= m.x7 - m.x79 >= -0.5)
m.e710 = Constraint(expr= m.x8 - m.x80 >= -0.5)
m.e711 = Constraint(expr= m.x9 - m.x81 >= -0.5)
m.e712 = Constraint(expr= m.x10 - m.x82 >= -0.5)
m.e713 = Constraint(expr= m.x11 - m.x83 >= -0.5)
m.e714 = Constraint(expr= m.x12 - m.x84 >= -0.5)
m.e715 = Constraint(expr= m.x13 - m.x85 >= -0.5)
m.e716 = Constraint(expr= m.x14 - m.x86 >= -0.5)
m.e717 = Constraint(expr= m.x15 - m.x87 >= -0.5)
m.e718 = Constraint(expr= m.x16 - m.x88 >= -0.5)
m.e719 = Constraint(expr= m.x17 - m.x89 >= -0.5)
m.e720 = Constraint(expr= m.x18 - m.x90 >= -0.5)
m.e721 = Constraint(expr= m.x19 - m.x91 >= -0.5)
m.e722 = Constraint(expr= m.x20 - m.x92 >= -0.5)
m.e723 = Constraint(expr= m.x21 - m.x93 >= -0.5)
m.e724 = Constraint(expr= m.x22 - m.x94 >= -0.5)
m.e725 = Constraint(expr= m.x23 - m.x95 >= -0.5)
m.e726 = Constraint(expr= m.x24 - m.x96 >= -0.5)
m.e727 = Constraint(expr= m.x25 - m.x97 >= -0.5)
m.e728 = Constraint(expr= m.x26 - m.x98 >= -0.5)
m.e729 = Constraint(expr= m.x27 - m.x99 >= -0.5)
m.e730 = Constraint(expr= m.x28 - m.x100 >= -0.5)
m.e731 = Constraint(expr= m.x29 - m.x101 >= -0.5)
m.e732 = Constraint(expr= m.x30 - m.x102 >= -0.5)
m.e733 = Constraint(expr= m.x31 - m.x103 >= -0.5)
m.e734 = Constraint(expr= m.x32 - m.x104 >= -0.5)
m.e735 = Constraint(expr= m.x33 - m.x105 >= -0.5)
m.e736 = Constraint(expr= m.x34 - m.x106 >= -0.5)
m.e737 = Constraint(expr= m.x35 - m.x107 >= -0.5)
m.e738 = Constraint(expr= m.x36 - m.x108 >= -0.5)
m.e739 = Constraint(expr= m.x37 + m.x73 <= 0.5)
m.e740 = Constraint(expr= m.x38 + m.x74 <= 0.5)
m.e741 = Constraint(expr= m.x39 + m.x75 <= 0.5)
m.e742 = Constraint(expr= m.x40 + m.x76 <= 0.5)
m.e743 = Constraint(expr= m.x41 + m.x77 <= 0.5)
m.e744 = Constraint(expr= m.x42 + m.x78 <= 0.5)
m.e745 = Constraint(expr= m.x43 + m.x79 <= 0.5)
m.e746 = Constraint(expr= m.x44 + m.x80 <= 0.5)
m.e747 = Constraint(expr= m.x45 + m.x81 <= 0.5)
m.e748 = Constraint(expr= m.x46 + m.x82 <= 0.5)
m.e749 = Constraint(expr= m.x47 + m.x83 <= 0.5)
m.e750 = Constraint(expr= m.x48 + m.x84 <= 0.5)
m.e751 = Constraint(expr= m.x49 + m.x85 <= 0.5)
m.e752 = Constraint(expr= m.x50 + m.x86 <= 0.5)
m.e753 = Constraint(expr= m.x51 + m.x87 <= 0.5)
m.e754 = Constraint(expr= m.x52 + m.x88 <= 0.5)
m.e755 = Constraint(expr= m.x53 + m.x89 <= 0.5)
m.e756 = Constraint(expr= m.x54 + m.x90 <= 0.5)
m.e757 = Constraint(expr= m.x55 + m.x91 <= 0.5)
m.e758 = Constraint(expr= m.x56 + m.x92 <= 0.5)
m.e759 = Constraint(expr= m.x57 + m.x93 <= 0.5)
m.e760 = Constraint(expr= m.x58 + m.x94 <= 0.5)
m.e761 = Constraint(expr= m.x59 + m.x95 <= 0.5)
m.e762 = Constraint(expr= m.x60 + m.x96 <= 0.5)
m.e763 = Constraint(expr= m.x61 + m.x97 <= 0.5)
m.e764 = Constraint(expr= m.x62 + m.x98 <= 0.5)
m.e765 = Constraint(expr= m.x63 + m.x99 <= 0.5)
m.e766 = Constraint(expr= m.x64 + m.x100 <= 0.5)
m.e767 = Constraint(expr= m.x65 + m.x101 <= 0.5)
m.e768 = Constraint(expr= m.x66 + m.x102 <= 0.5)
m.e769 = Constraint(expr= m.x67 + m.x103 <= 0.5)
m.e770 = Constraint(expr= m.x68 + m.x104 <= 0.5)
m.e771 = Constraint(expr= m.x69 + m.x105 <= 0.5)
m.e772 = Constraint(expr= m.x70 + m.x106 <= 0.5)
m.e773 = Constraint(expr= m.x71 + m.x107 <= 0.5)
m.e774 = Constraint(expr= m.x72 + m.x108 <= 0.5)
m.e775 = Constraint(expr= m.x37 - m.x73 >= -0.5)
m.e776 = Constraint(expr= m.x38 - m.x74 >= -0.5)
m.e777 = Constraint(expr= m.x39 - m.x75 >= -0.5)
m.e778 = Constraint(expr= m.x40 - m.x76 >= -0.5)
m.e779 = Constraint(expr= m.x41 - m.x77 >= -0.5)
m.e780 = Constraint(expr= m.x42 - m.x78 >= -0.5)
m.e781 = Constraint(expr= m.x43 - m.x79 >= -0.5)
m.e782 = Constraint(expr= m.x44 - m.x80 >= -0.5)
m.e783 = Constraint(expr= m.x45 - m.x81 >= -0.5)
m.e784 = Constraint(expr= m.x46 - m.x82 >= -0.5)
m.e785 = Constraint(expr= m.x47 - m.x83 >= -0.5)
m.e786 = Constraint(expr= m.x48 - m.x84 >= -0.5)
m.e787 = Constraint(expr= m.x49 - m.x85 >= -0.5)
m.e788 = Constraint(expr= m.x50 - m.x86 >= -0.5)
m.e789 = Constraint(expr= m.x51 - m.x87 >= -0.5)
m.e790 = Constraint(expr= m.x52 - m.x88 >= -0.5)
m.e791 = Constraint(expr= m.x53 - m.x89 >= -0.5)
m.e792 = Constraint(expr= m.x54 - m.x90 >= -0.5)
m.e793 = Constraint(expr= m.x55 - m.x91 >= -0.5)
m.e794 = Constraint(expr= m.x56 - m.x92 >= -0.5)
m.e795 = Constraint(expr= m.x57 - m.x93 >= -0.5)
m.e796 = Constraint(expr= m.x58 - m.x94 >= -0.5)
m.e797 = Constraint(expr= m.x59 - m.x95 >= -0.5)
m.e798 = Constraint(expr= m.x60 - m.x96 >= -0.5)
m.e799 = Constraint(expr= m.x61 - m.x97 >= -0.5)
m.e800 = Constraint(expr= m.x62 - m.x98 >= -0.5)
m.e801 = Constraint(expr= m.x63 - m.x99 >= -0.5)
m.e802 = Constraint(expr= m.x64 - m.x100 >= -0.5)
m.e803 = Constraint(expr= m.x65 - m.x101 >= -0.5)
m.e804 = Constraint(expr= m.x66 - m.x102 >= -0.5)
m.e805 = Constraint(expr= m.x67 - m.x103 >= -0.5)
m.e806 = Constraint(expr= m.x68 - m.x104 >= -0.5)
m.e807 = Constraint(expr= m.x69 - m.x105 >= -0.5)
m.e808 = Constraint(expr= m.x70 - m.x106 >= -0.5)
m.e809 = Constraint(expr= m.x71 - m.x107 >= -0.5)
m.e810 = Constraint(expr= m.x72 - m.x108 >= -0.5)
