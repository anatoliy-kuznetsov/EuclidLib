...
m.e327 = Constraint(expr= m.x54 - 0.7071067811865476 * m.x79 == 0)
m.e328 = Constraint(expr= m.x55 - 0.5773502691896257 * m.x79 == 0)
m.e329 = Constraint(expr= m.x56 - 0.5 * m.x79 == 0)
m.e330 = Constraint(expr= m.x57 - 0.447213595499958 * m.x79 == 0)
m.e331 = Constraint(expr= m.x58 - 0.408248290463863 * m.x79 == 0)
m.e332 = Constraint(expr= m.x59 - 0.37796447300922725 * m.x79 == 0)
m.e333 = Constraint(expr= m.x60 - 0.3535533905932738 * m.x79 == 0)
m.e334 = Constraint(expr= m.x61 - 0.3333333333333333 * m.x79 == 0)
m.e335 = Constraint(expr= m.x62 - 0.3162277660168379 * m.x79 == 0)
m.e336 = Constraint(expr= m.x63 - 0.30151134457776363 * m.x79 == 0)
m.e337 = Constraint(expr= m.x64 - 0.28867513459481287 * m.x79 == 0)
m.e338 = Constraint(expr= m.x65 - 0.2773500981126146 * m.x79 == 0)
m.e339 = Constraint(expr= m.x66 - 0.2672612419124244 * m.x79 == 0)
m.e340 = Constraint(expr= m.x67 - 0.25819888974716115 * m.x79 == 0)
m.e341 = Constraint(expr= m.x68 - 0.25 * m.x79 == 0)
m.e342 = Constraint(expr= m.x69 - 0.24253562503633297 * m.x79 == 0)
m.e343 = Constraint(expr= m.x70 - 0.23570226039551587 * m.x79 == 0)
m.e344 = Constraint(expr= m.x71 - 0.2294157338705618 * m.x79 == 0)
m.e345 = Constraint(expr= m.x72 - 0.223606797749979 * m.x79 == 0)
m.e346 = Constraint(expr= m.x73 - 0.2182178902359924 * m.x79 == 0)
m.e347 = Constraint(expr= m.x74 - 0.21320071635561041 * m.x79 == 0)
m.e348 = Constraint(expr= m.x75 - 0.20851441405707477 * m.x79 == 0)
m.e349 = Constraint(expr= m.x76 - 0.20412414523193148 * m.x79 == 0)
m.e350 = Constraint(expr= m.x77 - 0.2 * m.x79 == 0)
m.e351 = Constraint(expr= m.x78 - 0.19611613513818402 * m.x79 == 0)
m.e352 = Constraint(expr= m.x1**2 + m.x27**2 - (1 - m.x53)**2 <= 0)
m.e353 = Constraint(expr= m.x2**2 + m.x28**2 - (1 - m.x54)**2 <= 0)
m.e354 = Constraint(expr= m.x3**2 + m.x29**2 - (1 - m.x55)**2 <= 0)
m.e355 = Constraint(expr= m.x4**2 + m.x30**2 - (1 - m.x56)**2 <= 0)
m.e356 = Constraint(expr= m.x5**2 + m.x31**2 - (1 - m.x57)**2 <= 0)
m.e357 = Constraint(expr= m.x6**2 + m.x32**2 - (1 - m.x58)**2 <= 0)
m.e358 = Constraint(expr= m.x7**2 + m.x33**2 - (1 - m.x59)**2 <= 0)
m.e359 = Constraint(expr= m.x8**2 + m.x34**2 - (1 - m.x60)**2 <= 0)
m.e360 = Constraint(expr= m.x9**2 + m.x35**2 - (1 - m.x61)**2 <= 0)
m.e361 = Constraint(expr= m.x10**2 + m.x36**2 - (1 - m.x62)**2 <= 0)
m.e362 = Constraint(expr= m.x11**2 + m.x37**2 - (1 - m.x63)**2 <= 0)
m.e363 = Constraint(expr= m.x12**2 + m.x38**2 - (1 - m.x64)**2 <= 0)
m.e364 = Constraint(expr= m.x13**2 + m.x39**2 - (1 - m.x65)**2 <= 0)
m.e365 = Constraint(expr= m.x14**2 + m.x40**2 - (1 - m.x66)**2 <= 0)
m.e366 = Constraint(expr= m.x15**2 + m.x41**2 - (1 - m.x67)**2 <= 0)
m.e367 = Constraint(expr= m.x16**2 + m.x42**2 - (1 - m.x68)**2 <= 0)
m.e368 = Constraint(expr= m.x17**2 + m.x43**2 - (1 - m.x69)**2 <= 0)
m.e369 = Constraint(expr= m.x18**2 + m.x44**2 - (1 - m.x70)**2 <= 0)
m.e370 = Constraint(expr= m.x19**2 + m.x45**2 - (1 - m.x71)**2 <= 0)
m.e371 = Constraint(expr= m.x20**2 + m.x46**2 - (1 - m.x72)**2 <= 0)
m.e372 = Constraint(expr= m.x21**2 + m.x47**2 - (1 - m.x73)**2 <= 0)
m.e373 = Constraint(expr= m.x22**2 + m.x48**2 - (1 - m.x74)**2 <= 0)
m.e374 = Constraint(expr= m.x23**2 + m.x49**2 - (1 - m.x75)**2 <= 0)
m.e375 = Constraint(expr= m.x24**2 + m.x50**2 - (1 - m.x76)**2 <= 0)
m.e376 = Constraint(expr= m.x25**2 + m.x51**2 - (1 - m.x77)**2 <= 0)
m.e377 = Constraint(expr= m.x26**2 + m.x52**2 - (1 - m.x78)**2 <= 0)
