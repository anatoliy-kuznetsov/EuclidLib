...
m.e23 = Constraint(expr= m.x16 - 2 * m.x22 == 0)
m.e24 = Constraint(expr= m.x17 - 3.0000000000000004 * m.x22 == 0)
m.e25 = Constraint(expr= m.x18 - 4 * m.x22 == 0)
m.e26 = Constraint(expr= m.x19 - 4.999999999999999 * m.x22 == 0)
m.e27 = Constraint(expr= m.x20 - 6 * m.x22 == 0)
m.e28 = Constraint(expr= m.x21 - 6.999999999999999 * m.x22 == 0)
