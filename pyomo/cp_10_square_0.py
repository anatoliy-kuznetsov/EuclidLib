...
m.e47 = Constraint(expr= m.x22 - m.x31 == 0)
m.e48 = Constraint(expr= m.x23 - m.x31 == 0)
m.e49 = Constraint(expr= m.x24 - m.x31 == 0)
m.e50 = Constraint(expr= m.x25 - m.x31 == 0)
m.e51 = Constraint(expr= m.x26 - m.x31 == 0)
m.e52 = Constraint(expr= m.x27 - m.x31 == 0)
m.e53 = Constraint(expr= m.x28 - m.x31 == 0)
m.e54 = Constraint(expr= m.x29 - m.x31 == 0)
m.e55 = Constraint(expr= m.x30 - m.x31 == 0)
m.e56 = Constraint(expr= m.x1 + m.x21 <= 0.5)
m.e57 = Constraint(expr= m.x2 + m.x22 <= 0.5)
m.e58 = Constraint(expr= m.x3 + m.x23 <= 0.5)
m.e59 = Constraint(expr= m.x4 + m.x24 <= 0.5)
m.e60 = Constraint(expr= m.x5 + m.x25 <= 0.5)
m.e61 = Constraint(expr= m.x6 + m.x26 <= 0.5)
m.e62 = Constraint(expr= m.x7 + m.x27 <= 0.5)
m.e63 = Constraint(expr= m.x8 + m.x28 <= 0.5)
m.e64 = Constraint(expr= m.x9 + m.x29 <= 0.5)
m.e65 = Constraint(expr= m.x10 + m.x30 <= 0.5)
m.e66 = Constraint(expr= m.x1 - m.x21 >= -0.5)
m.e67 = Constraint(expr= m.x2 - m.x22 >= -0.5)
m.e68 = Constraint(expr= m.x3 - m.x23 >= -0.5)
m.e69 = Constraint(expr= m.x4 - m.x24 >= -0.5)
m.e70 = Constraint(expr= m.x5 - m.x25 >= -0.5)
m.e71 = Constraint(expr= m.x6 - m.x26 >= -0.5)
m.e72 = Constraint(expr= m.x7 - m.x27 >= -0.5)
m.e73 = Constraint(expr= m.x8 - m.x28 >= -0.5)
m.e74 = Constraint(expr= m.x9 - m.x29 >= -0.5)
m.e75 = Constraint(expr= m.x10 - m.x30 >= -0.5)
m.e76 = Constraint(expr= m.x11 + m.x21 <= 0.5)
m.e77 = Constraint(expr= m.x12 + m.x22 <= 0.5)
m.e78 = Constraint(expr= m.x13 + m.x23 <= 0.5)
m.e79 = Constraint(expr= m.x14 + m.x24 <= 0.5)
m.e80 = Constraint(expr= m.x15 + m.x25 <= 0.5)
m.e81 = Constraint(expr= m.x16 + m.x26 <= 0.5)
m.e82 = Constraint(expr= m.x17 + m.x27 <= 0.5)
m.e83 = Constraint(expr= m.x18 + m.x28 <= 0.5)
m.e84 = Constraint(expr= m.x19 + m.x29 <= 0.5)
m.e85 = Constraint(expr= m.x20 + m.x30 <= 0.5)
m.e86 = Constraint(expr= m.x11 - m.x21 >= -0.5)
m.e87 = Constraint(expr= m.x12 - m.x22 >= -0.5)
m.e88 = Constraint(expr= m.x13 - m.x23 >= -0.5)
m.e89 = Constraint(expr= m.x14 - m.x24 >= -0.5)
m.e90 = Constraint(expr= m.x15 - m.x25 >= -0.5)
m.e91 = Constraint(expr= m.x16 - m.x26 >= -0.5)
m.e92 = Constraint(expr= m.x17 - m.x27 >= -0.5)
m.e93 = Constraint(expr= m.x18 - m.x28 >= -0.5)
m.e94 = Constraint(expr= m.x19 - m.x29 >= -0.5)
m.e95 = Constraint(expr= m.x20 - m.x30 >= -0.5)
