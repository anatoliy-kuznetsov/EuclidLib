# NLP written by GAMS Convert at 05/15/24 11:44:22
#
# Equation counts
#     Total        E        G        L        N        X        C        B
...
m.e80 = Constraint(expr= m.x28 - 2 * m.x40 == 0)
m.e81 = Constraint(expr= m.x29 - 3.0000000000000004 * m.x40 == 0)
m.e82 = Constraint(expr= m.x30 - 4 * m.x40 == 0)
m.e83 = Constraint(expr= m.x31 - 4.999999999999999 * m.x40 == 0)
m.e84 = Constraint(expr= m.x32 - 6 * m.x40 == 0)
m.e85 = Constraint(expr= m.x33 - 6.999999999999999 * m.x40 == 0)
m.e86 = Constraint(expr= m.x34 - 7.999999999999998 * m.x40 == 0)
m.e87 = Constraint(expr= m.x35 - 9.000000000000002 * m.x40 == 0)
m.e88 = Constraint(expr= m.x36 - 10.000000000000002 * m.x40 == 0)
m.e89 = Constraint(expr= m.x37 - 11.000000000000002 * m.x40 == 0)
m.e90 = Constraint(expr= m.x38 - 12 * m.x40 == 0)
m.e91 = Constraint(expr= m.x39 - 13 * m.x40 == 0)
