# NLP written by GAMS Convert at 05/15/24 11:43:27
#
# Equation counts
#     Total        E        G        L        N        X        C        B
...
m.e255 = Constraint(expr= m.x48 - 0.7071067811865476 * m.x70 == 0)
m.e256 = Constraint(expr= m.x49 - 0.5773502691896257 * m.x70 == 0)
m.e257 = Constraint(expr= m.x50 - 0.5 * m.x70 == 0)
m.e258 = Constraint(expr= m.x51 - 0.447213595499958 * m.x70 == 0)
m.e259 = Constraint(expr= m.x52 - 0.408248290463863 * m.x70 == 0)
m.e260 = Constraint(expr= m.x53 - 0.37796447300922725 * m.x70 == 0)
m.e261 = Constraint(expr= m.x54 - 0.3535533905932738 * m.x70 == 0)
m.e262 = Constraint(expr= m.x55 - 0.3333333333333333 * m.x70 == 0)
m.e263 = Constraint(expr= m.x56 - 0.3162277660168379 * m.x70 == 0)
m.e264 = Constraint(expr= m.x57 - 0.30151134457776363 * m.x70 == 0)
m.e265 = Constraint(expr= m.x58 - 0.28867513459481287 * m.x70 == 0)
m.e266 = Constraint(expr= m.x59 - 0.2773500981126146 * m.x70 == 0)
m.e267 = Constraint(expr= m.x60 - 0.2672612419124244 * m.x70 == 0)
m.e268 = Constraint(expr= m.x61 - 0.25819888974716115 * m.x70 == 0)
m.e269 = Constraint(expr= m.x62 - 0.25 * m.x70 == 0)
m.e270 = Constraint(expr= m.x63 - 0.24253562503633297 * m.x70 == 0)
m.e271 = Constraint(expr= m.x64 - 0.23570226039551587 * m.x70 == 0)
m.e272 = Constraint(expr= m.x65 - 0.2294157338705618 * m.x70 == 0)
m.e273 = Constraint(expr= m.x66 - 0.223606797749979 * m.x70 == 0)
m.e274 = Constraint(expr= m.x67 - 0.2182178902359924 * m.x70 == 0)
m.e275 = Constraint(expr= m.x68 - 0.21320071635561041 * m.x70 == 0)
m.e276 = Constraint(expr= m.x69 - 0.20851441405707477 * m.x70 == 0)
m.e277 = Constraint(expr= m.x1**2 + m.x24**2 - (1 - m.x47)**2 <= 0)
m.e278 = Constraint(expr= m.x2**2 + m.x25**2 - (1 - m.x48)**2 <= 0)
m.e279 = Constraint(expr= m.x3**2 + m.x26**2 - (1 - m.x49)**2 <= 0)
m.e280 = Constraint(expr= m.x4**2 + m.x27**2 - (1 - m.x50)**2 <= 0)
m.e281 = Constraint(expr= m.x5**2 + m.x28**2 - (1 - m.x51)**2 <= 0)
m.e282 = Constraint(expr= m.x6**2 + m.x29**2 - (1 - m.x52)**2 <= 0)
m.e283 = Constraint(expr= m.x7**2 + m.x30**2 - (1 - m.x53)**2 <= 0)
m.e284 = Constraint(expr= m.x8**2 + m.x31**2 - (1 - m.x54)**2 <= 0)
m.e285 = Constraint(expr= m.x9**2 + m.x32**2 - (1 - m.x55)**2 <= 0)
m.e286 = Constraint(expr= m.x10**2 + m.x33**2 - (1 - m.x56)**2 <= 0)
m.e287 = Constraint(expr= m.x11**2 + m.x34**2 - (1 - m.x57)**2 <= 0)
m.e288 = Constraint(expr= m.x12**2 + m.x35**2 - (1 - m.x58)**2 <= 0)
m.e289 = Constraint(expr= m.x13**2 + m.x36**2 - (1 - m.x59)**2 <= 0)
m.e290 = Constraint(expr= m.x14**2 + m.x37**2 - (1 - m.x60)**2 <= 0)
m.e291 = Constraint(expr= m.x15**2 + m.x38**2 - (1 - m.x61)**2 <= 0)
m.e292 = Constraint(expr= m.x16**2 + m.x39**2 - (1 - m.x62)**2 <= 0)
m.e293 = Constraint(expr= m.x17**2 + m.x40**2 - (1 - m.x63)**2 <= 0)
m.e294 = Constraint(expr= m.x18**2 + m.x41**2 - (1 - m.x64)**2 <= 0)
m.e295 = Constraint(expr= m.x19**2 + m.x42**2 - (1 - m.x65)**2 <= 0)
m.e296 = Constraint(expr= m.x20**2 + m.x43**2 - (1 - m.x66)**2 <= 0)
m.e297 = Constraint(expr= m.x21**2 + m.x44**2 - (1 - m.x67)**2 <= 0)
m.e298 = Constraint(expr= m.x22**2 + m.x45**2 - (1 - m.x68)**2 <= 0)
m.e299 = Constraint(expr= m.x23**2 + m.x46**2 - (1 - m.x69)**2 <= 0)
