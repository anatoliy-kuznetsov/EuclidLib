...
m.e107 = Constraint(expr= m.x32 - 0.7071067811865476 * m.x46 == 0)
m.e108 = Constraint(expr= m.x33 - 0.5773502691896257 * m.x46 == 0)
m.e109 = Constraint(expr= m.x34 - 0.5 * m.x46 == 0)
m.e110 = Constraint(expr= m.x35 - 0.447213595499958 * m.x46 == 0)
m.e111 = Constraint(expr= m.x36 - 0.408248290463863 * m.x46 == 0)
m.e112 = Constraint(expr= m.x37 - 0.37796447300922725 * m.x46 == 0)
m.e113 = Constraint(expr= m.x38 - 0.3535533905932738 * m.x46 == 0)
m.e114 = Constraint(expr= m.x39 - 0.3333333333333333 * m.x46 == 0)
m.e115 = Constraint(expr= m.x40 - 0.3162277660168379 * m.x46 == 0)
m.e116 = Constraint(expr= m.x41 - 0.30151134457776363 * m.x46 == 0)
m.e117 = Constraint(expr= m.x42 - 0.28867513459481287 * m.x46 == 0)
m.e118 = Constraint(expr= m.x43 - 0.2773500981126146 * m.x46 == 0)
m.e119 = Constraint(expr= m.x44 - 0.2672612419124244 * m.x46 == 0)
m.e120 = Constraint(expr= m.x45 - 0.25819888974716115 * m.x46 == 0)
m.e121 = Constraint(expr= m.x1**2 + m.x16**2 - (1 - m.x31)**2 <= 0)
m.e122 = Constraint(expr= m.x2**2 + m.x17**2 - (1 - m.x32)**2 <= 0)
m.e123 = Constraint(expr= m.x3**2 + m.x18**2 - (1 - m.x33)**2 <= 0)
m.e124 = Constraint(expr= m.x4**2 + m.x19**2 - (1 - m.x34)**2 <= 0)
m.e125 = Constraint(expr= m.x5**2 + m.x20**2 - (1 - m.x35)**2 <= 0)
m.e126 = Constraint(expr= m.x6**2 + m.x21**2 - (1 - m.x36)**2 <= 0)
m.e127 = Constraint(expr= m.x7**2 + m.x22**2 - (1 - m.x37)**2 <= 0)
m.e128 = Constraint(expr= m.x8**2 + m.x23**2 - (1 - m.x38)**2 <= 0)
m.e129 = Constraint(expr= m.x9**2 + m.x24**2 - (1 - m.x39)**2 <= 0)
m.e130 = Constraint(expr= m.x10**2 + m.x25**2 - (1 - m.x40)**2 <= 0)
m.e131 = Constraint(expr= m.x11**2 + m.x26**2 - (1 - m.x41)**2 <= 0)
m.e132 = Constraint(expr= m.x12**2 + m.x27**2 - (1 - m.x42)**2 <= 0)
m.e133 = Constraint(expr= m.x13**2 + m.x28**2 - (1 - m.x43)**2 <= 0)
m.e134 = Constraint(expr= m.x14**2 + m.x29**2 - (1 - m.x44)**2 <= 0)
m.e135 = Constraint(expr= m.x15**2 + m.x30**2 - (1 - m.x45)**2 <= 0)
