...
m.e12 = Constraint(expr= m.x12 - 0.7071067811865476 * m.x16 == 0)
m.e13 = Constraint(expr= m.x13 - 0.5773502691896257 * m.x16 == 0)
m.e14 = Constraint(expr= m.x14 - 0.5 * m.x16 == 0)
m.e15 = Constraint(expr= m.x15 - 0.447213595499958 * m.x16 == 0)
