...
m.e122 = Constraint(expr= m.x34 - 0.7071067811865476 * m.x49 == 0)
m.e123 = Constraint(expr= m.x35 - 0.5773502691896257 * m.x49 == 0)
m.e124 = Constraint(expr= m.x36 - 0.5 * m.x49 == 0)
m.e125 = Constraint(expr= m.x37 - 0.447213595499958 * m.x49 == 0)
m.e126 = Constraint(expr= m.x38 - 0.408248290463863 * m.x49 == 0)
m.e127 = Constraint(expr= m.x39 - 0.37796447300922725 * m.x49 == 0)
m.e128 = Constraint(expr= m.x40 - 0.3535533905932738 * m.x49 == 0)
m.e129 = Constraint(expr= m.x41 - 0.3333333333333333 * m.x49 == 0)
m.e130 = Constraint(expr= m.x42 - 0.3162277660168379 * m.x49 == 0)
m.e131 = Constraint(expr= m.x43 - 0.30151134457776363 * m.x49 == 0)
m.e132 = Constraint(expr= m.x44 - 0.28867513459481287 * m.x49 == 0)
m.e133 = Constraint(expr= m.x45 - 0.2773500981126146 * m.x49 == 0)
m.e134 = Constraint(expr= m.x46 - 0.2672612419124244 * m.x49 == 0)
m.e135 = Constraint(expr= m.x47 - 0.25819888974716115 * m.x49 == 0)
m.e136 = Constraint(expr= m.x48 - 0.25 * m.x49 == 0)
m.e137 = Constraint(expr= m.x1**2 + m.x17**2 - (1 - m.x33)**2 <= 0)
m.e138 = Constraint(expr= m.x2**2 + m.x18**2 - (1 - m.x34)**2 <= 0)
m.e139 = Constraint(expr= m.x3**2 + m.x19**2 - (1 - m.x35)**2 <= 0)
m.e140 = Constraint(expr= m.x4**2 + m.x20**2 - (1 - m.x36)**2 <= 0)
m.e141 = Constraint(expr= m.x5**2 + m.x21**2 - (1 - m.x37)**2 <= 0)
m.e142 = Constraint(expr= m.x6**2 + m.x22**2 - (1 - m.x38)**2 <= 0)
m.e143 = Constraint(expr= m.x7**2 + m.x23**2 - (1 - m.x39)**2 <= 0)
m.e144 = Constraint(expr= m.x8**2 + m.x24**2 - (1 - m.x40)**2 <= 0)
m.e145 = Constraint(expr= m.x9**2 + m.x25**2 - (1 - m.x41)**2 <= 0)
m.e146 = Constraint(expr= m.x10**2 + m.x26**2 - (1 - m.x42)**2 <= 0)
m.e147 = Constraint(expr= m.x11**2 + m.x27**2 - (1 - m.x43)**2 <= 0)
m.e148 = Constraint(expr= m.x12**2 + m.x28**2 - (1 - m.x44)**2 <= 0)
m.e149 = Constraint(expr= m.x13**2 + m.x29**2 - (1 - m.x45)**2 <= 0)
m.e150 = Constraint(expr= m.x14**2 + m.x30**2 - (1 - m.x46)**2 <= 0)
m.e151 = Constraint(expr= m.x15**2 + m.x31**2 - (1 - m.x47)**2 <= 0)
m.e152 = Constraint(expr= m.x16**2 + m.x32**2 - (1 - m.x48)**2 <= 0)
