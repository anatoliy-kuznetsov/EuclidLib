...
m.e38 = Constraint(expr= m.x20 - 0.7071067811865476 * m.x28 == 0)
m.e39 = Constraint(expr= m.x21 - 0.5773502691896257 * m.x28 == 0)
m.e40 = Constraint(expr= m.x22 - 0.5 * m.x28 == 0)
m.e41 = Constraint(expr= m.x23 - 0.447213595499958 * m.x28 == 0)
m.e42 = Constraint(expr= m.x24 - 0.408248290463863 * m.x28 == 0)
m.e43 = Constraint(expr= m.x25 - 0.37796447300922725 * m.x28 == 0)
m.e44 = Constraint(expr= m.x26 - 0.3535533905932738 * m.x28 == 0)
m.e45 = Constraint(expr= m.x27 - 0.3333333333333333 * m.x28 == 0)
m.e46 = Constraint(expr= m.x1**2 + m.x10**2 - (1 - m.x19)**2 <= 0)
m.e47 = Constraint(expr= m.x2**2 + m.x11**2 - (1 - m.x20)**2 <= 0)
m.e48 = Constraint(expr= m.x3**2 + m.x12**2 - (1 - m.x21)**2 <= 0)
m.e49 = Constraint(expr= m.x4**2 + m.x13**2 - (1 - m.x22)**2 <= 0)
m.e50 = Constraint(expr= m.x5**2 + m.x14**2 - (1 - m.x23)**2 <= 0)
m.e51 = Constraint(expr= m.x6**2 + m.x15**2 - (1 - m.x24)**2 <= 0)
m.e52 = Constraint(expr= m.x7**2 + m.x16**2 - (1 - m.x25)**2 <= 0)
m.e53 = Constraint(expr= m.x8**2 + m.x17**2 - (1 - m.x26)**2 <= 0)
m.e54 = Constraint(expr= m.x9**2 + m.x18**2 - (1 - m.x27)**2 <= 0)
