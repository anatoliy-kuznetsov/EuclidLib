...
m.e12 = Constraint(expr= m.x12 - 2 * m.x16 == 0)
m.e13 = Constraint(expr= m.x13 - 3.0000000000000004 * m.x16 == 0)
m.e14 = Constraint(expr= m.x14 - 4 * m.x16 == 0)
m.e15 = Constraint(expr= m.x15 - 4.999999999999999 * m.x16 == 0)
m.e16 = Constraint(expr= m.x1**2 + m.x6**2 - (1 - m.x11)**2 <= 0)
m.e17 = Constraint(expr= m.x2**2 + m.x7**2 - (1 - m.x12)**2 <= 0)
m.e18 = Constraint(expr= m.x3**2 + m.x8**2 - (1 - m.x13)**2 <= 0)
m.e19 = Constraint(expr= m.x4**2 + m.x9**2 - (1 - m.x14)**2 <= 0)
m.e20 = Constraint(expr= m.x5**2 + m.x10**2 - (1 - m.x15)**2 <= 0)
