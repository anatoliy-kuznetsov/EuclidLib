...
m.e66 = Constraint(expr= (m.x11 - m.x12)**2 + (m.x23 - m.x24)**2 - (m.x35 +
    m.x36)**2 >= 0)
m.e67 = Constraint(expr= m.x25 - m.x37 == 0)
m.e68 = Constraint(expr= m.x26 - m.x37 == 0)
m.e69 = Constraint(expr= m.x27 - m.x37 == 0)
m.e70 = Constraint(expr= m.x28 - m.x37 == 0)
m.e71 = Constraint(expr= m.x29 - m.x37 == 0)
m.e72 = Constraint(expr= m.x30 - m.x37 == 0)
m.e73 = Constraint(expr= m.x31 - m.x37 == 0)
m.e74 = Constraint(expr= m.x32 - m.x37 == 0)
m.e75 = Constraint(expr= m.x33 - m.x37 == 0)
m.e76 = Constraint(expr= m.x34 - m.x37 == 0)
m.e77 = Constraint(expr= m.x35 - m.x37 == 0)
m.e78 = Constraint(expr= m.x36 - m.x37 == 0)
m.e79 = Constraint(expr= m.x1 + m.x25 <= 0.5)
m.e80 = Constraint(expr= m.x2 + m.x26 <= 0.5)
m.e81 = Constraint(expr= m.x3 + m.x27 <= 0.5)
m.e82 = Constraint(expr= m.x4 + m.x28 <= 0.5)
m.e83 = Constraint(expr= m.x5 + m.x29 <= 0.5)
m.e84 = Constraint(expr= m.x6 + m.x30 <= 0.5)
m.e85 = Constraint(expr= m.x7 + m.x31 <= 0.5)
m.e86 = Constraint(expr= m.x8 + m.x32 <= 0.5)
m.e87 = Constraint(expr= m.x9 + m.x33 <= 0.5)
m.e88 = Constraint(expr= m.x10 + m.x34 <= 0.5)
m.e89 = Constraint(expr= m.x11 + m.x35 <= 0.5)
m.e90 = Constraint(expr= m.x12 + m.x36 <= 0.5)
m.e91 = Constraint(expr= m.x1 - m.x25 >= -0.5)
m.e92 = Constraint(expr= m.x2 - m.x26 >= -0.5)
m.e93 = Constraint(expr= m.x3 - m.x27 >= -0.5)
m.e94 = Constraint(expr= m.x4 - m.x28 >= -0.5)
m.e95 = Constraint(expr= m.x5 - m.x29 >= -0.5)
m.e96 = Constraint(expr= m.x6 - m.x30 >= -0.5)
m.e97 = Constraint(expr= m.x7 - m.x31 >= -0.5)
m.e98 = Constraint(expr= m.x8 - m.x32 >= -0.5)
m.e99 = Constraint(expr= m.x9 - m.x33 >= -0.5)
m.e100 = Constraint(expr= m.x10 - m.x34 >= -0.5)
m.e101 = Constraint(expr= m.x11 - m.x35 >= -0.5)
m.e102 = Constraint(expr= m.x12 - m.x36 >= -0.5)
m.e103 = Constraint(expr= m.x13 + m.x25 <= 0.5)
m.e104 = Constraint(expr= m.x14 + m.x26 <= 0.5)
m.e105 = Constraint(expr= m.x15 + m.x27 <= 0.5)
m.e106 = Constraint(expr= m.x16 + m.x28 <= 0.5)
m.e107 = Constraint(expr= m.x17 + m.x29 <= 0.5)
m.e108 = Constraint(expr= m.x18 + m.x30 <= 0.5)
m.e109 = Constraint(expr= m.x19 + m.x31 <= 0.5)
m.e110 = Constraint(expr= m.x20 + m.x32 <= 0.5)
m.e111 = Constraint(expr= m.x21 + m.x33 <= 0.5)
m.e112 = Constraint(expr= m.x22 + m.x34 <= 0.5)
m.e113 = Constraint(expr= m.x23 + m.x35 <= 0.5)
m.e114 = Constraint(expr= m.x24 + m.x36 <= 0.5)
m.e115 = Constraint(expr= m.x13 - m.x25 >= -0.5)
m.e116 = Constraint(expr= m.x14 - m.x26 >= -0.5)
m.e117 = Constraint(expr= m.x15 - m.x27 >= -0.5)
m.e118 = Constraint(expr= m.x16 - m.x28 >= -0.5)
m.e119 = Constraint(expr= m.x17 - m.x29 >= -0.5)
m.e120 = Constraint(expr= m.x18 - m.x30 >= -0.5)
m.e121 = Constraint(expr= m.x19 - m.x31 >= -0.5)
m.e122 = Constraint(expr= m.x20 - m.x32 >= -0.5)
m.e123 = Constraint(expr= m.x21 - m.x33 >= -0.5)
m.e124 = Constraint(expr= m.x22 - m.x34 >= -0.5)
m.e125 = Constraint(expr= m.x23 - m.x35 >= -0.5)
m.e126 = Constraint(expr= m.x24 - m.x36 >= -0.5)
