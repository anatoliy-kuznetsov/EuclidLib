...
m.e38 = Constraint(expr= m.x20 - 2 * m.x28 == 0)
m.e39 = Constraint(expr= m.x21 - 3.0000000000000004 * m.x28 == 0)
m.e40 = Constraint(expr= m.x22 - 4 * m.x28 == 0)
m.e41 = Constraint(expr= m.x23 - 4.999999999999999 * m.x28 == 0)
m.e42 = Constraint(expr= m.x24 - 6 * m.x28 == 0)
m.e43 = Constraint(expr= m.x25 - 6.999999999999999 * m.x28 == 0)
m.e44 = Constraint(expr= m.x26 - 7.999999999999998 * m.x28 == 0)
m.e45 = Constraint(expr= m.x27 - 9.000000000000002 * m.x28 == 0)
