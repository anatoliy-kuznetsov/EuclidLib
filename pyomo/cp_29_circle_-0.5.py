...
m.e408 = Constraint(expr= m.x60 - 0.7071067811865476 * m.x88 == 0)
m.e409 = Constraint(expr= m.x61 - 0.5773502691896257 * m.x88 == 0)
m.e410 = Constraint(expr= m.x62 - 0.5 * m.x88 == 0)
m.e411 = Constraint(expr= m.x63 - 0.447213595499958 * m.x88 == 0)
m.e412 = Constraint(expr= m.x64 - 0.408248290463863 * m.x88 == 0)
m.e413 = Constraint(expr= m.x65 - 0.37796447300922725 * m.x88 == 0)
m.e414 = Constraint(expr= m.x66 - 0.3535533905932738 * m.x88 == 0)
m.e415 = Constraint(expr= m.x67 - 0.3333333333333333 * m.x88 == 0)
m.e416 = Constraint(expr= m.x68 - 0.3162277660168379 * m.x88 == 0)
m.e417 = Constraint(expr= m.x69 - 0.30151134457776363 * m.x88 == 0)
m.e418 = Constraint(expr= m.x70 - 0.28867513459481287 * m.x88 == 0)
m.e419 = Constraint(expr= m.x71 - 0.2773500981126146 * m.x88 == 0)
m.e420 = Constraint(expr= m.x72 - 0.2672612419124244 * m.x88 == 0)
m.e421 = Constraint(expr= m.x73 - 0.25819888974716115 * m.x88 == 0)
m.e422 = Constraint(expr= m.x74 - 0.25 * m.x88 == 0)
m.e423 = Constraint(expr= m.x75 - 0.24253562503633297 * m.x88 == 0)
m.e424 = Constraint(expr= m.x76 - 0.23570226039551587 * m.x88 == 0)
m.e425 = Constraint(expr= m.x77 - 0.2294157338705618 * m.x88 == 0)
m.e426 = Constraint(expr= m.x78 - 0.223606797749979 * m.x88 == 0)
m.e427 = Constraint(expr= m.x79 - 0.2182178902359924 * m.x88 == 0)
m.e428 = Constraint(expr= m.x80 - 0.21320071635561041 * m.x88 == 0)
m.e429 = Constraint(expr= m.x81 - 0.20851441405707477 * m.x88 == 0)
m.e430 = Constraint(expr= m.x82 - 0.20412414523193148 * m.x88 == 0)
m.e431 = Constraint(expr= m.x83 - 0.2 * m.x88 == 0)
m.e432 = Constraint(expr= m.x84 - 0.19611613513818402 * m.x88 == 0)
m.e433 = Constraint(expr= m.x85 - 0.19245008972987526 * m.x88 == 0)
m.e434 = Constraint(expr= m.x86 - 0.18898223650461363 * m.x88 == 0)
m.e435 = Constraint(expr= m.x87 - 0.18569533817705186 * m.x88 == 0)
