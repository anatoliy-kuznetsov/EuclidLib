...
m.e173 = Constraint(expr= m.x40 - m.x58 == 0)
m.e174 = Constraint(expr= m.x41 - m.x58 == 0)
m.e175 = Constraint(expr= m.x42 - m.x58 == 0)
m.e176 = Constraint(expr= m.x43 - m.x58 == 0)
m.e177 = Constraint(expr= m.x44 - m.x58 == 0)
m.e178 = Constraint(expr= m.x45 - m.x58 == 0)
m.e179 = Constraint(expr= m.x46 - m.x58 == 0)
m.e180 = Constraint(expr= m.x47 - m.x58 == 0)
m.e181 = Constraint(expr= m.x48 - m.x58 == 0)
m.e182 = Constraint(expr= m.x49 - m.x58 == 0)
m.e183 = Constraint(expr= m.x50 - m.x58 == 0)
m.e184 = Constraint(expr= m.x51 - m.x58 == 0)
m.e185 = Constraint(expr= m.x52 - m.x58 == 0)
m.e186 = Constraint(expr= m.x53 - m.x58 == 0)
m.e187 = Constraint(expr= m.x54 - m.x58 == 0)
m.e188 = Constraint(expr= m.x55 - m.x58 == 0)
m.e189 = Constraint(expr= m.x56 - m.x58 == 0)
m.e190 = Constraint(expr= m.x57 - m.x58 == 0)
m.e191 = Constraint(expr= m.x1 + m.x39 <= 0.5)
m.e192 = Constraint(expr= m.x2 + m.x40 <= 0.5)
m.e193 = Constraint(expr= m.x3 + m.x41 <= 0.5)
m.e194 = Constraint(expr= m.x4 + m.x42 <= 0.5)
m.e195 = Constraint(expr= m.x5 + m.x43 <= 0.5)
m.e196 = Constraint(expr= m.x6 + m.x44 <= 0.5)
m.e197 = Constraint(expr= m.x7 + m.x45 <= 0.5)
m.e198 = Constraint(expr= m.x8 + m.x46 <= 0.5)
m.e199 = Constraint(expr= m.x9 + m.x47 <= 0.5)
m.e200 = Constraint(expr= m.x10 + m.x48 <= 0.5)
m.e201 = Constraint(expr= m.x11 + m.x49 <= 0.5)
m.e202 = Constraint(expr= m.x12 + m.x50 <= 0.5)
m.e203 = Constraint(expr= m.x13 + m.x51 <= 0.5)
m.e204 = Constraint(expr= m.x14 + m.x52 <= 0.5)
m.e205 = Constraint(expr= m.x15 + m.x53 <= 0.5)
m.e206 = Constraint(expr= m.x16 + m.x54 <= 0.5)
m.e207 = Constraint(expr= m.x17 + m.x55 <= 0.5)
m.e208 = Constraint(expr= m.x18 + m.x56 <= 0.5)
m.e209 = Constraint(expr= m.x19 + m.x57 <= 0.5)
m.e210 = Constraint(expr= m.x1 - m.x39 >= -0.5)
m.e211 = Constraint(expr= m.x2 - m.x40 >= -0.5)
m.e212 = Constraint(expr= m.x3 - m.x41 >= -0.5)
m.e213 = Constraint(expr= m.x4 - m.x42 >= -0.5)
m.e214 = Constraint(expr= m.x5 - m.x43 >= -0.5)
m.e215 = Constraint(expr= m.x6 - m.x44 >= -0.5)
m.e216 = Constraint(expr= m.x7 - m.x45 >= -0.5)
m.e217 = Constraint(expr= m.x8 - m.x46 >= -0.5)
m.e218 = Constraint(expr= m.x9 - m.x47 >= -0.5)
m.e219 = Constraint(expr= m.x10 - m.x48 >= -0.5)
m.e220 = Constraint(expr= m.x11 - m.x49 >= -0.5)
m.e221 = Constraint(expr= m.x12 - m.x50 >= -0.5)
m.e222 = Constraint(expr= m.x13 - m.x51 >= -0.5)
m.e223 = Constraint(expr= m.x14 - m.x52 >= -0.5)
m.e224 = Constraint(expr= m.x15 - m.x53 >= -0.5)
m.e225 = Constraint(expr= m.x16 - m.x54 >= -0.5)
m.e226 = Constraint(expr= m.x17 - m.x55 >= -0.5)
m.e227 = Constraint(expr= m.x18 - m.x56 >= -0.5)
m.e228 = Constraint(expr= m.x19 - m.x57 >= -0.5)
m.e229 = Constraint(expr= m.x20 + m.x39 <= 0.5)
m.e230 = Constraint(expr= m.x21 + m.x40 <= 0.5)
m.e231 = Constraint(expr= m.x22 + m.x41 <= 0.5)
m.e232 = Constraint(expr= m.x23 + m.x42 <= 0.5)
m.e233 = Constraint(expr= m.x24 + m.x43 <= 0.5)
m.e234 = Constraint(expr= m.x25 + m.x44 <= 0.5)
m.e235 = Constraint(expr= m.x26 + m.x45 <= 0.5)
m.e236 = Constraint(expr= m.x27 + m.x46 <= 0.5)
m.e237 = Constraint(expr= m.x28 + m.x47 <= 0.5)
m.e238 = Constraint(expr= m.x29 + m.x48 <= 0.5)
m.e239 = Constraint(expr= m.x30 + m.x49 <= 0.5)
m.e240 = Constraint(expr= m.x31 + m.x50 <= 0.5)
m.e241 = Constraint(expr= m.x32 + m.x51 <= 0.5)
m.e242 = Constraint(expr= m.x33 + m.x52 <= 0.5)
m.e243 = Constraint(expr= m.x34 + m.x53 <= 0.5)
m.e244 = Constraint(expr= m.x35 + m.x54 <= 0.5)
m.e245 = Constraint(expr= m.x36 + m.x55 <= 0.5)
m.e246 = Constraint(expr= m.x37 + m.x56 <= 0.5)
m.e247 = Constraint(expr= m.x38 + m.x57 <= 0.5)
m.e248 = Constraint(expr= m.x20 - m.x39 >= -0.5)
m.e249 = Constraint(expr= m.x21 - m.x40 >= -0.5)
m.e250 = Constraint(expr= m.x22 - m.x41 >= -0.5)
m.e251 = Constraint(expr= m.x23 - m.x42 >= -0.5)
m.e252 = Constraint(expr= m.x24 - m.x43 >= -0.5)
m.e253 = Constraint(expr= m.x25 - m.x44 >= -0.5)
m.e254 = Constraint(expr= m.x26 - m.x45 >= -0.5)
m.e255 = Constraint(expr= m.x27 - m.x46 >= -0.5)
m.e256 = Constraint(expr= m.x28 - m.x47 >= -0.5)
m.e257 = Constraint(expr= m.x29 - m.x48 >= -0.5)
m.e258 = Constraint(expr= m.x30 - m.x49 >= -0.5)
m.e259 = Constraint(expr= m.x31 - m.x50 >= -0.5)
m.e260 = Constraint(expr= m.x32 - m.x51 >= -0.5)
m.e261 = Constraint(expr= m.x33 - m.x52 >= -0.5)
m.e262 = Constraint(expr= m.x34 - m.x53 >= -0.5)
m.e263 = Constraint(expr= m.x35 - m.x54 >= -0.5)
m.e264 = Constraint(expr= m.x36 - m.x55 >= -0.5)
m.e265 = Constraint(expr= m.x37 - m.x56 >= -0.5)
m.e266 = Constraint(expr= m.x38 - m.x57 >= -0.5)
