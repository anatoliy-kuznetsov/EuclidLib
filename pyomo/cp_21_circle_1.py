# NLP written by GAMS Convert at 05/15/24 11:44:12
#
# Equation counts
#     Total        E        G        L        N        X        C        B
...
m.e212 = Constraint(expr= m.x44 - 2 * m.x64 == 0)
m.e213 = Constraint(expr= m.x45 - 3.0000000000000004 * m.x64 == 0)
m.e214 = Constraint(expr= m.x46 - 4 * m.x64 == 0)
m.e215 = Constraint(expr= m.x47 - 4.999999999999999 * m.x64 == 0)
m.e216 = Constraint(expr= m.x48 - 6 * m.x64 == 0)
m.e217 = Constraint(expr= m.x49 - 6.999999999999999 * m.x64 == 0)
m.e218 = Constraint(expr= m.x50 - 7.999999999999998 * m.x64 == 0)
m.e219 = Constraint(expr= m.x51 - 9.000000000000002 * m.x64 == 0)
m.e220 = Constraint(expr= m.x52 - 10.000000000000002 * m.x64 == 0)
m.e221 = Constraint(expr= m.x53 - 11.000000000000002 * m.x64 == 0)
m.e222 = Constraint(expr= m.x54 - 12 * m.x64 == 0)
m.e223 = Constraint(expr= m.x55 - 13 * m.x64 == 0)
m.e224 = Constraint(expr= m.x56 - 13.999999999999996 * m.x64 == 0)
m.e225 = Constraint(expr= m.x57 - 15 * m.x64 == 0)
m.e226 = Constraint(expr= m.x58 - 15.999999999999998 * m.x64 == 0)
m.e227 = Constraint(expr= m.x59 - 17 * m.x64 == 0)
m.e228 = Constraint(expr= m.x60 - 17.999999999999996 * m.x64 == 0)
m.e229 = Constraint(expr= m.x61 - 18.999999999999996 * m.x64 == 0)
m.e230 = Constraint(expr= m.x62 - 19.999999999999996 * m.x64 == 0)
m.e231 = Constraint(expr= m.x63 - 21 * m.x64 == 0)
